    ...
    <tr>
      <td align="center"><form id="form1" name="form1" method="post" action="grabarnotario.php">
        <table width="740" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="36" colspan="6"><span style="font-family:Verdana, Geneva, sans-serif; font-size:14px; color:#036;"><strong>INGRESE DATOS DEL NOTARIO</strong></span></td>
            </tr>
          <tr>
            <td width="150">&nbsp;</td>
            <td width="226">&nbsp;</td>
		  ...
		  <tr>
            ...
            <td colspan="4"><input type="text"  style="text-transform:uppercase;"  name="codoficial" id="codoficial"  size="50" maxlength="11" /></td>
            <td>&nbsp;</td>
          </tr>
		  <tr>
            <td height="31"><span style="font-family:Verdana, Geneva, sans-serif; font-size:14px; color:#036;">Código de Notaria</span></td>
            <td colspan="4"><input type="text"  style="text-transform:uppercase;"  name="coduif" id="coduif"  size="50" maxlength="11" /></td>
            <td>&nbsp;</td>
			<tr><td>&nbsp;</td></tr>
          </tr>
            <td height="50">&nbsp;</td>
            <td><input type="submit" name="button" id="button" value="Grabar Datos" /></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
