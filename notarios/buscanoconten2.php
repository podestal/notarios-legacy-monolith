...
echo"<table width='834' border='1' cellpadding='0' cellspacing='0' bordercolor='#E5E5E5'>
  <tr>
    <td width='234' height='19' valign='top'><span class='Estilo12'>".$row['cliente']."</span></td>
    <td width='82' valign='top'><span class='Estilo12'>".$row['fec_escritura']."</span></td>
    <td width='54' valign='top'><span class='Estilo12'>".$row['kardex']."</span></td>
    <td width='239' valign='top'><span class='Estilo12'>".$row['contrato']."</span></td>
    <td width='93' valign='top'><span class='Estilo12'>".$row['numescritura']."</span></td>
    <td width='63' valign='top'><span class='Estilo12'>".$row['numminuta']."</span></td>
    <td width='53' valign='top'><span class='Estilo12'>".$row['folioini']."</span></td>
  </tr>
</table>";
}
