        ...
        <td height="30" colspan="5" ><table width="175" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="175"><label><span class="camposss">
              <input type="hidden" name="codclie" id="codclie" value="<?php echo $ncliente; ?>"   /><input type='hidden' name='idubigeo' id='idubigeo'  value='<?php echo $row['idubigeo']; ?>' /><input name='empresa' type='hidden'   id='empresa' />
              </span></label></td>
            </tr>
          </table></td>
      </tr>
