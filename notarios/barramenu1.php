			...
			function Show()
				{
					...
					if($this->Genera=="1"){$barra = $barra.'<td><button title="Generar" type="button" name="Generar"    id="Generar"    value="Generar" onclick="'.$this->GeneraClick.'"   ><img src="images/generate.png" width="17" height="17" align="absmiddle" />Acta</button></td>';}
					if($this->Notificacion=="1"){$barra = $barra.'<td><button title="Notificacion" type="button" name="Notificacion"    id="Notificacion"    value="Notificacion" onclick="'.$this->NotiClick.'"   ><img src="images/obs.png" width="17" height="17" align="absmiddle" />Notificacion</button></td>';}
