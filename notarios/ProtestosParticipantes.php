...
function fNotificacion(_id_poder,_id_contrata)
	{
		
	$('<div id="div_generacion" title="div_generacion"></div>').load('IngProtestoNotif.php?id_poder='+_id_poder+'&id_contrata='+_id_contrata)
	.dialog({
					autoOpen: true,
					position :["center","top"],
					width   : 400,
...
protesto_participantes.descri_parti, c_protesto.des_condicionp
...
echo "<table width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#333333' >
  <tr>
	...
	<td width='15' align='center' ><span class='reskar'><a href='#' id='".$row['id_protesto']."' name='".$row['id_participante']."' onclick='EditPartiP(this.id,this.name)'><img src='iconos/editamv.png' width='16' height='18'></a></span></td>
