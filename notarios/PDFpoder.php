...
?>
                ...
                <p align="center">
                     <strong>INDICE CRONOLOGICO DE PODERES</strong></p>
       ...
       <!--<TR><TD width="70" height="19">Numero</TD><TD width="86">Fec. Ingr.</TD><TD width="86">Fec. Dilig.</TD><TD width="93">Zona</TD><TD width="171">&nbsp; Remitente</TD><TD width="275">&nbsp; Destinatario</TD></TR>-->
                ...
                <TD width="200">Tip.Poder</td>
                <TD width="86">Fecha Crono.</td>
                <TD width="350">Participantes</td>
...
try
{
	...
	$html2pdf->Output('icronoPoder.pdf');
}
