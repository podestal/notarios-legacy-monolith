...
$apepat4=strtoupper(str_replace("ñ","Ñ",$_POST['apepat4']));
$apemat4=strtoupper(str_replace("ñ","Ñ",$_POST['apemat4']));
$prinom4=strtoupper(str_replace("ñ","Ñ",$_POST['prinom4']));
$segnom4=strtoupper(str_replace("ñ","Ñ",$_POST['segnom4']));
