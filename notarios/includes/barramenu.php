			...
			function Show()
				{
					...
					if($this->Genera=="1"){$barra = $barra.'<td><button title="Generar" type="button" name="Generar"    id="Generar"    value="Generar" onclick="'.$this->GeneraClick.'"   ><img src="../../images/generate.png" width="17" height="17" align="absmiddle" /></br>Genera Crono.</button></td>';}
					...
					if($this->Impri=="1"){$barra = $barra.'<td><button title="reporte" type="button" name="Imprim"   id="Imprim"   value="Imprimir" onclick="'.$this->ImpriClick.'" ><img src="../../images/print.png" width="17" height="17" align="absmiddle" /></br>Genera Doc.</button></td>';}
