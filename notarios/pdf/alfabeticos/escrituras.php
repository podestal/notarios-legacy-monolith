<?php
   ...
   $i=0;
	...
	function FancyTable($header, $data, $fechaa, $fechade, $num)
	{
        ...
        $this->Cell(145,10, 'INDICE ALFABETICO DE ESCRITURAS PUBLICAS' ,0,0,'C');
		$this->Ln(15);
	...
	$header = array('Contratantes', 'Fec. Escritura', 'Kardex', 'Acto', utf8_decode('Nº Escritura'), utf8_decode('Nº Minuta'),utf8_decode('Nº Folio'));
