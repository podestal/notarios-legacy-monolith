<?php
   ...
   $i=0;
	...
	function FancyTable($header, $data, $fechaa, $fechade, $num)
	{
        ...
        $this->Cell(145,10, 'INDICE ALFABETICO DE TRANSFERENCIA VEHICULAR' ,0,0,'C');
		$this->Ln(15);
		...
		foreach($data as $row)
		{
			...
			$this->Cell($w[5],6,$row["folioini"],'LR',0,'C',$fill);
			$this->Ln();
			$fill = !$fill;
			$n++;
		}
	...
	$header = array('Contratantes', 'Fec. Escritura', 'Kardex', 'Acto', utf8_decode('Nº Acta'), utf8_decode('Nº Folio'));
