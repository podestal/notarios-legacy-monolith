...
//$rowVehiX = mysql_fetch_array($sqllistbie);
//echo $rowVehi[0];exit();
...
echo "<table width='650' border='1' cellpadding='0' cellspacing='0' bordercolor='#333333'>
 ...
 while($rowVehi = mysql_fetch_array($sqllistbie)){
  echo"<tr>
    ...
    <td align='center' bgcolor='#FFFFFF'><a href='#' id='".$rowVehi['detveh']."' onclick='muesVehiEditable(this.id)'><img src='iconos/editamv.png' width='16' height='18'></a></td>
    <td align='center' bgcolor='#FFFFFF'><a href='#' id='".$rowVehi['detveh']."' onclick='ElimVehi(this.id)'><img src='iconos/eliminamv.png' width='18' height='17'></a></td>
  </tr>";
  }
