...
echo str_pad(substr(intval($tipokardexx),0,1),1," ",STR_PAD_LEFT)."|".
str_pad(substr(intval($numeroescritura),0,5),5," ",STR_PAD_LEFT)."|".
str_pad(substr($secuacto,0,5),5," ",STR_PAD_RIGHT)."|".
str_pad(substr($secuoto,0,5),5," ",STR_PAD_RIGHT)."|".
str_pad(substr($tipootorgante,0,2),2," ",STR_PAD_RIGHT)."|".
str_pad(substr($numformu,0,10),10," ",STR_PAD_RIGHT)."|".
str_pad(substr($pagoformu,0,15),15," ",STR_PAD_RIGHT)."|".chr(13).chr(10);
		}
}
