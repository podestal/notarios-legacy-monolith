...
$consulcontrat = mysql_query("SELECT * FROM	protesto_participantes WHERE protesto_participantes.id_protesto='$id_prote' AND protesto_participantes.id_participante = '$id_contrata' and protesto_participantes.anio='$anio'", $conn) or die(mysql_error());
...
<script type="text/javascript">
	...
	function evalGuardaParticipante() { fAddCondiciones4(); }
                  ...
                  <tr>
                    ...
                    <td width="550"><table width="510" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="160" align="center" bgcolor="#FFFFFF"><input name="numdoc" type="text" id="numdoc" size="18"    /></td>
                        <td width="77" align="right" bgcolor="#FFFFFF"><a  onclick="vercliente();"><img src="iconos/buscarclie.png" alt="" width="72" height="29" border="0" /></a></td>
