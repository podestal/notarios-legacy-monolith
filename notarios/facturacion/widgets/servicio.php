  ...
  <form id="frm_pago" name="frm_pago">
        <table width="752">
                ...
                <tr height="40">
                    ...
                    <td width="125">
                    <div id="div_precio">
                    <input id="precio" name="precio" type="text" class="camposss" style="width:100px"  value="0.00" maxlength="6" onchange="currency(this.value);" onkeypress="return numerosdecimales (event)"  />
                    </div>
                    </td>
                    <td colspan="4">
                    	<table width="358">
