	...
	$consulta_cliente =  "select 
						...
						CONCAT(ubigeo.nomdis,'-',ubigeo.nomprov,'-',ubigeo.nomdpto) as nomdis,
    ...
    <table width="754">
            <tr>
				...
				<td width="340">
                	<select id="select_doic" name="select_doic" class="camposss" onchange="cambiar_doic('doic', this.value)" style="width:310px">
				...
				<td width="102">
				<input id="doic" name="doic" type="text" class="camposss" style="width:100px" onkeypress="actualizar_datoscliente(event); return isNumberKey(event)"  value="<?php echo $doic;?>" /></td>
                <td width="22"><!--<img src="../../images/search.png" width="20" height="20" onClick=" nuevo_cliente();" style="cursor:pointer">--></td>
                
               
                <td width="102">
                	<input id="txtCodeCaptcha" name="codeCaptcha"  type="text" class="camposss" style="width:100px;display:none;" placeholder="CODIGO" maxlength="4" />
                </td>
                <td>
                	<img id="imgCaptcha" src="" style="display:none;" width="120" height="38">
                </td>
                <td width="58">
                	<a id="btnSearchReniecSunat" href="javascript:;" style="display:none;"><img src="../../iconos/buscarclie.png" width="72" height="29"></a>
                </td>

            </tr>
            <tr>
            	<td colspan="2">
            		<div id="msg-error" style="color: #a94442;background-color: #f2dede;border-color: #ebccd1;padding: 15px;border: 1px solid transparent;border-radius: 4px;display:none;" ></div>
            	</td>
            </tr>
            <tr>
