// JavaScript Document
	...
	function listar_anular(pag){
		...
		new Ajax.Updater("div_anular", "../consultas/list_anulacion_egreso.php?"+campos+"&pag="+pagina);	
	...
	function desactivar_venta(at, as, ad, id){
		...
		if (r == true) {
			...
			new Ajax.Request("../consultas/desactivar_egreso.php?a_t="+at+"&a_s="+as+"&a_d="+ad+"&id="+id,
		    {  
		    onComplete: 
		    function() { 
