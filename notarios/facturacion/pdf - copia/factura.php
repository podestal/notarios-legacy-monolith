...
?>
  ...
  <tr>
    ...
    <td colspan="4" valign="top" class="aaaa"><?php echo strtoupper(substr($nombre,0,strrpos(substr($nombre,0,$maximo_nombre)," ")));  ?></td>
    <td colspan="4"></td>
  </tr>
  <tr>
    <td colspan="2" >&nbsp;</td>
    <td colspan="8" ><div align="left" ><?php
	strtoupper(substr($arr_regventa[8],0,strrpos(substr($arr_regventa[8],0,$maximo_direccion)," "))); ?></div></td>
  </tr>
  <tr>
...
?>	
    ...
    <td width="827"><div align="left"><?php echo $arr_dregventas[$i][4]; ?></div></td>
