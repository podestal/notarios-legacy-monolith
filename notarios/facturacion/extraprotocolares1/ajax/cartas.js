// JavaScript Document
	...
	function buscar_cartas(page){
		...
		if(flag ==1){
		   ...
		   new Ajax.Updater("lista_cartas", "busqueda_cartas.php?" + campos+"&pag=" + page);
	...
	function ver_cartas(id_cartas){
		document.location.href="EditCartasVie.php?numcarta="+id_cartas;
	}
