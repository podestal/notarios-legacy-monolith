...
echo "<table width='880' border='1' cellpadding='0' cellspacing='0' bordercolor='#333333' >
  <tr>
    ...
    <td width='25' bgcolor='#FFFFFF'><span class='textocontratantesss'><a href='#' id='".$row['id_cambio']."' name='".$row['id_solicitante']."' onclick='editarsolicitante2(this.id,this.name)'><img src='../../iconos/editacontrar.png' width='22'  height='22' border='0' title='Editar Contratante' /></a></span></td>
  </tr>
</table>";
$i++;
}
