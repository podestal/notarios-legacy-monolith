      ...
      <td><form id="frm_buscarviaje" name="frm_buscarviaje" method="post" action="">
        <table width="837" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="202"><label><input id="participante" name="participante" type="text" style="text-transform:uppercase;" size="30" maxlength="50" onclick="limpiartextosgen()"/>
            </label></td>
             <td width="89" align="right"><span class="titubuskar0">
             Nro Control :</span></td>
            <td width="140"><label><input id="nro_control" name="nro_control" style="text-transform:uppercase;"  type="text"  size="11" onkeypress="return isNumberKey(event)" onclick="limpiarcontrol()" />
            </label></td>
          </tr>
          <tr>
            <td width="62">&nbsp;</td>
            <td width="72">&nbsp;</td>
            <td width="22"><span class="titubuskar0"></span></td>
          </tr>
        </table>
        <table>
        <tr>
