	...
	function ggclie1result()
	 {
		...
		if( _apepat.value == '' || _prinom.value == ''  || _direccion.value == '')
...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="30" bgcolor="#FFFFFF"><input type="text" onkeypress="return soloLetras(event)" name="segnom" style="text-transform:uppercase" id="segnom" /></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FFFFFF">&nbsp;</td>
