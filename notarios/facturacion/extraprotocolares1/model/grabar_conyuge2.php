...
$prinom2=$_POST['prinom2'];
$segnom2=$_POST['segnom2'];
$nombre2=$apepat2." ".$apemat2.", ".$prinom2." ".$segnom2;
...
$nomprofesiones2=$_POST['nomprofesiones'];
$idprofesion2=intval($_POST['idprofesion']);
...
$idprofesion2=$idprofesion2;
}

if ($nomprofesiones2==""){
$nomprofesiones2="";
}else{
$nomprofesiones2=$nomprofesiones2;
}
