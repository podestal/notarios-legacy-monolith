    ...
    <script type="text/javascript" src="../Ajax/anular.js" >
	<?php 
...
-->
	...
	<table width="850" border="1" cellspacing="0" cellpadding="0" align="center">
			  ...
			  <td width="65" align="center"><span class="titubuskar0">ReImprimir</span></td>
              <td width="65" align="center"><span class="titubuskar0">Editar</span></td>
		  ...
		  for($j=0; $j<count($arr_cuentas); $j++){ ?>
         	 <tr>
				...
				?>
                 ...
                 <td align='center'><span class='reskar'>
				<a href='#' onclick="imprimir_comprobante('<?php echo $arr_cuentas[$j][7]; ?>')"  title="Reimprimir"><img src='../../iconos/nuevo2.png' width='24' height='20'></a>
				</span>
                <div id="imprimir_todo" style="display:"></div>
                </td>
                <td align='center'>
                	<a href='#' onclick="editar_comprobrante('<?php echo $arr_cuentas[$j][7]; ?>')"  title="Editar"><img src='../../iconos/edit_x.png' width='24' height='20'></a>
                </td>
