...
<script type="text/javascript" src="../Ajax/reporte_e.js" ></script>
    ...
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="354"><span class="titulosprincipales">Reporte de Comprobantes Emitidos</span></td>
        ...
        <tr>
          ...
          <form id="frm_fechas" name="frm_fechas" method="post" action="">
            <table width="847" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="44"><span class="Estilo7">De Fecha </span></td>
                <td width="156"><span class="Estilo7">
                  <label>
                  <input name="fechade" type="text" class="tcal" id="fechade" readonly />
                  </label>
                </span></td>
                <td width="21"><span class="Estilo7">a</span></td>
                <td width="33"><span class="Estilo7">Fecha</span></td>
                <td width="156"><label>
                  <input name="fechaa" type="text" class="tcal" id="fechaa" readonly />
                </label></td>
                <td width="104"><a href="#" onClick="listar_reporte_e(1)"><img src="../../iconos/buscarclie.png" width="72" height="29" border="0" /></a></td>
                ...
                <td width="60"><a href="#" onClick="pdf_reporte()"><img src="../../iconos/pdf.png" alt="" width="33" height="31" border="0" /></a></td>
                <td width="62"><a href="#" onClick="excel_reporte()"><img src="../../iconos/excel.png" alt="" width="33" height="31" border="0" /></a></td>
              </tr>
            </table>
           </form>
           </td>
