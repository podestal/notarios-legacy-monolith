...
<script type="text/javascript" src="../Ajax/anular_egreso.js" ></script>
    ...
    <tr>
     <td>
         ...
         <div id="div_buscaclie">
           ...
           <table  width="95%">
             <tr>
            	<td width="13%" height="35"><span class="camposss">Tipo Documento:
            	  <?php   
                ...
                <td width="17%"><select id="a_tipcomp" name="a_tipcomp" style='width:167px;' class='camposss' onChange="listar_anular(1)">
            	...
            	<td width="6%"><span class="camposss"> SERIE:</span></td>
                <td colspan="3"><input id="a_serie" name="a_serie" class="camposss" style="width:100px" maxlength="15" onKeyPress="return isNumberKey(event)"/>                  <input type="hidden" id="a_doic" name="a_doic" class="camposss" style="width:100px" maxlength="6" onKeyPress="return isNumberKey(event)"/></td>
                </tr>
            <tr>
