...
<table id="table_sis" style="width:850px" align="center">
     	...
     	<td>
        	<table width="810">
            		<tr>
                        ...
                        <td width="167"><div id="slc_tipdoc"></div></td>
                        <td width="78"><span class="camposss" style="margin-left:10px">N. Docum:</span></td>
                        <td width="35">
                        <div id="div_serie"></div>
                        </td>
                        <td width="9"><span>--</span></td>
                        <td width="120">
                        <div id="div_numdoc"></div>
                        </td>
                        <td width="109"><span class="camposss">Fecha de Emisión:</span></td>
                        <td width="112">
                        <input id="fecha_emision1" name="fecha_emision1" type="text"  style="width:90px; color:#777777; display:none" value="<?php echo date("d/m/Y"); ?>" readonly class="tcal" />
                        <input id="fecha_emision2" name="fecha_emision2" type="text"  style="width:90px; color:#777777" value="<?php echo date("d/m/Y"); ?>" disabled="disabled" class="tcal" /></td>
                        <td width="38"><img src="../../images/pencil.png" width="20" height="20" style="cursor:pointer" onClick="ver_login()"></td>
                        <input id="usuario_sesion" name="usuario_sesion" type="hidden"  style="text-transform:uppercase" size="15" value="<?php echo $_SESSION["id_usu"]; ?>" />
                    </tr>
            </table>	
        </td>
     </tr>
     ...
     <tr>
     	<td>
        	<div id="div_detalleslc" style="border: 2px solid #D3D3D3; border-radius: 8px ; padding:5px"></div>	
        </td>
     </tr>
     <tr>
     	<td>
        	<table>
            		<tr>
                        ...
                        <img src="../../images/new.png" width="20" height="20" /><span style="color:#3A7099; position:relative; left:5px; top:-5px; width:120px"><B>SERVICIOS</B></span>
     ...
     <tr>
     	<td>
        	<div id="div_servicio" style="border: 1px solid ; border-radius: 8px ; padding:5px; display:none">
         	...
         	<div id="div_textarea" style="border: 1px #777 solid ; border-radius: 8px ;  width:auto; height:70px; display:none">
            	<table>
                	<tr>
                        ...
                        <td>
                        	<textarea id="comentarios" name="comentarios" class="camposss" style="width:800px; height:60px; text-transform:uppercase" maxlength="550">
                            </textarea>
                        </td>	
                    </tr>
                </table>
     ...
     <tr style="height:auto">
     	<td>
        	<div id="div_detalle" style="border: 1px solid ; border-radius: 8px ;  width:auto; height:auto; min-height:120px">
