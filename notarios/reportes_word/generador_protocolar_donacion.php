...
// Se verifica que formato de plantilla se usara.
	$template = "plantilla_protocolar_donacion.odt";
		...
		if($rowcontratantes[12]=='006' || $rowcontratantes[12]=='043' || $rowcontratantes[12]=='049' || $rowcontratantes[12]=='055' || $rowcontratantes[12]=='113' || $rowcontratantes[12]=='188' || $rowcontratantes[12]=='117' || $rowcontratantes[12]=='175' )
			{
				if($rowcontratantes[12]=='117' || $rowcontratantes[12]=='175') // evalua al apoderado o representante
				{
					if($rowcontratantes[15]=='006' || $rowcontratantes[15]=='043' || $rowcontratantes[15]=='049' || $rowcontratantes[15]=='055' || $rowcontratantes[15]=='113' || $rowcontratantes[12]=='188')
						{
							$evalcondicion = "COMO DONANTE"; // ES EL APODERADO DEL TRANSFERENTE
						}
					    ...
					    {
							$evalcondicion = "COMO DONATARIO"; // ES EL APODERADO DEL ADQUIRIENTE
						}
				}
				else // SI NO ES APODERADO SIGUE EL FLUJO NORMAL 113 VENDEDOR (TRANSFERENTE)-.-"
				{
					$evalcondicion = "COMO DONANTE "; // $evalcondicion = "COMO TRANSFERENTE ";	
				} // 117 -> APODERADO
				...
				{
					$evalcondicion = "COMO DONATARIO"; // $evalcondicion = "COMO ADQUIRIENTE ";	
				} // ADQUIRIENTE  
...
IF(ubigeo.coddis="070101","DISTRITO DE CALLAO , PROVINCIA CONSTITUCIONAL DEL CALLAO",CONCAT("DISTRITO DE ",ubigeo.nomdis, ", PROVINCIA DE ", ubigeo.nomprov,", DEPARTAMENTO DE ",ubigeo.nomdpto )) AS "Distrito"
		...
		if($rowjuridica[12]=='188')
		{
			$evalcondij= "COMO DONANTE";
			}else if($rowjuridica[12]=='189'){$evalcondij= "COMO DONATARIO";}
		if($rowjuridica[10]=='J')
		{
		...
		$dataContratantes3[] = array('nom_transferente'=>$eval_mostrar_personax);
		}
		else if($rowjuridica[12]=='007' || $rowjuridica[12]=='044' || $rowjuridica[12]=='050' || $rowjuridica[12]=='056' || $rowjuridica[12]=='114' || $rowcontratantes[12]=='189' || $rowjuridica[12]=='189') # ADQUIRIENTE
		{	
		...
		$dataContratantes4[] = array('nom_adquiriente'=>$eval_mostrar_personay);
	...
	// 	 $eval_mostrar_persona_tran .= $eval_mostrar_personax;  EVALUA UNIDAD
	//	 $eval_mostrar_persona_adq  .= $eval_mostrar_personay;	EVALUA UNIDAD
		...
		if($rowcontratantes[12]=='006' || $rowcontratantes[12]=='043' || $rowcontratantes[12]=='049' || $rowcontratantes[12]=='055' || $rowcontratantes[12]=='113' || $rowcontratantes[12]=='188' || $rowcontratantes[12]=='117' || $rowcontratantes[12]=='175')
			{
				if($rowcontratantes[12]=='117' || $rowcontratantes[12]=='175') // evalua al apoderado o representante
				{
					if($rowcontratantes[15]=='006' || $rowcontratantes[15]=='043' || $rowcontratantes[15]=='049' || $rowcontratantes[15]=='055' || $rowcontratantes[15]=='113' || $rowcontratantes[15]=='188')
						{
							$evalcondicion = "COMO DONANTE "; // ES EL APODERADO DEL TRASNFERENTE
						}
