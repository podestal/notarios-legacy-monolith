...
$sqlarchi = "SELECT codoficial, coduif, RIGHT (CONCAT('00000000', coduif),9)AS uif FROM confinotario WHERE idnotar='1'";
$resultarchi=mysql_query($sqlarchi,$conn);
$rowarchi = mysql_fetch_array($resultarchi);
$ano=date('Y');

$codoficial=$rowarchi['codoficial'];//11
$coduif=$rowarchi['coduif'];//8
$coduiftodo=$rowarchi['uif'];//8

$fechade=$_GET["fec_desde"];
$fechaha=$_GET["fhasta"];

$fechaxx = explode ("/", $fechaha);
$anito=substr($fechaxx[2],2,2);
$mesesito=$fechaxx[1];
$diita=$fechaxx[0];

$archivo = "04".$anito.$mesesito.$diita."501.".$coduif;
//00000039975029044451
...
$cabeceraro="050104     20".$anito.$mesesito.$diita."012               ".$coduiftodo.$codoficial;
...
while($row = mysql_fetch_array($result)) {
  ...
  if($fecha_mes<>12){
	 ...
	 $fecha_next="01/01/".$cadena2; 
	  ...
	  if($valor_conclu=="NO"){ $conclu='N'; }
	  if($valor_conclu=="SI"){ if($fec1<$fec2){ $conclu='C'; }else{ $conclu='N';} }
	 ...
	 /*//////////////////////////// A PARTIR DE AQUI COMENZAMOS A CREAR LAS FILAS DE OPRACION Y LOS PARTICIPANTES //////////////////////////////////////////////*/
			...
			$valor_detalle=mysql_num_rows($resregis2);
				...
				if($valor_detalle!=0){
					 ...
					 if($nump!="" && $sr!=""){
						$incri="I"; $sedereg=$rowregis2['idsedereg']; $numpartida=(strtoupper($rowregis2['pregistral']));
			...
			$rowregis = mysql_fetch_array($resregis);
			    if($valor_detalle2!=0){
					...
					if($nump2!="" && $sr2!="" ){
						$incri="I"; $sedereg=$rowregis['idsedereg']; $numpartida=(strtoupper($rowregis['pregistral']));
						}else{ $incri="N"; $sedereg=""; $numpartida="";}
			...
			if($valor_medio_pago!=0){
				...
				//	/*54*/	   str_pad(substr($vaciomonto,0,6),'6'," ",STR_PAD_LEFT).		# tip_cambio			|	N
					           str_pad(substr($tipcambio,0,6),'6'," ",STR_PAD_LEFT).		# tip_cambio			|	N
			...
			if($valor_contratantes!=0){
				...
				if($tipoppersona=="N"){$tp="1"; $objciiu=""; $numeruc=""; $feccumpleclie = $fechitacumple; $autografo=$firmass;  $ciius="";$codnacion=$rownacionalidad['codnacion']; $numedoc=$numdocu; $apepat_empre=str_replace("Ã","I",str_replace("Ã“","O",str_replace("`"," ",str_replace(")"," ",str_replace("("," ",str_replace("-"," ",str_replace("Âº"," ",str_replace(","," ",str_replace("."," ",str_replace("?"," ",str_replace("*"," ",str_replace("Ã‘","#",str_replace("Ã±","#",$rowcontrata['apepat']))))))))))))); $apemat=str_replace("Ã","I",str_replace("Ã“","O",str_replace("`"," ",str_replace(")"," ",str_replace("("," ",str_replace("-"," ",str_replace("Âº"," ",str_replace(","," ",str_replace("."," ",str_replace("?"," ",str_replace("*"," ",str_replace("Ã‘","#",str_replace("Ã±","#",$rowcontrata['apemat']))))))))))))); $direc_per_empre=str_replace("Ã","I",str_replace("Ã“","O",str_replace("`"," ",str_replace(")"," ",str_replace("("," ",str_replace("-"," ",str_replace("Âº"," ",str_replace(","," ",str_replace("."," ",str_replace("?"," ",str_replace("*"," ",str_replace("Ã‘","#",str_replace("Ã±","#",$rowcontrata['direccion']))))))))))))); $nombres=str_replace("Ã","I",str_replace("Ã“","O",str_replace("`"," ",str_replace(")"," ",str_replace("("," ",str_replace("-"," ",str_replace("Âº"," ",str_replace(","," ",str_replace("."," ",str_replace("?"," ",str_replace("*"," ",str_replace("Ã‘","#",str_replace("Ã±","#",$rowcontrata['prinom']." ".$rowcontrata['segnom']))))))))))))); $estciv=$estado_civil; if($profecion!=''){$profis=$profecion;} if($cargoprof!=""){$cargoprofis=$cargoprof;} if($td!="8"){$tipdoc=$td;}}else{$numedoc=""; $nombres=""; $codnacion=""; $estciv=""; $profis=""; $cargoprofis=""; $nombres=""; $feccumpleclie = ""; $autografo=""; if($apemat==""){$apemat=".";}else{$apemat=$apemat;} }
				 ...
				 if($sederegparti!="0"){if(strlen($sederegparti)>1){$srparti=$sederegparti;}else{$srparti="0".$sederegparti;}}else{$srparti="";}
				 if($numpartiparti!=""){$nparti=$numpartiparti;}
				 ...
				 //aqui coloque 2 de no inscrito pk el sistema no tiene actualizado el inscrito y ede registral ni numeor de partida
				  ...
				  if($uif=='B'){$bene="B"; $inscri=""; $repre=""; $rpa="";}else{$bene="";} 
					   ...
					   echo /*1*/          str_pad(substr($correlativo,0,8),'8'," ",STR_PAD_LEFT).		# cdg_fil				|	N
							...
							/*49*/		   str_pad(substr(strtoupper(holaacentos($ofondo)),0,40),'40'," ",STR_PAD_RIGHT).					# ori_fondos			|	C
...
}else{//A PARTIR DE AQUI COMIENZA A COGER LAS COMPLEMENTARIAS EN EL ELSE/////////////////////////////////////////////////////////////////
		  
	 /*//////////////////////////// A PARTIR DE AQUI COMENZAMOS A CREAR LAS FILAS DE LOS PARTICIPANTES //////////////////////////////////////////////*/
				...
				if($tipoppersona=="N"){$tp="1"; $objciiu=""; $numeruc=""; $feccumpleclie = $fechitacumple; $autografo=$firmass;  $ciius="";$codnacion=$rownacionalidad['codnacion']; $numedoc=$numdocu; $apepat_empre=str_replace("Ã","I",str_replace("Ã“","O",str_replace("`"," ",str_replace(")"," ",str_replace("("," ",str_replace("-"," ",str_replace("Âº"," ",str_replace(","," ",str_replace("."," ",str_replace("?"," ",str_replace("*"," ",str_replace("Ã‘","#",str_replace("Ã±","#",$rowcontrata['apepat']))))))))))))); $apemat=str_replace("Ã","I",str_replace("Ã“","O",str_replace("`"," ",str_replace(")"," ",str_replace("("," ",str_replace("-"," ",str_replace("Âº"," ",str_replace(","," ",str_replace("."," ",str_replace("?"," ",str_replace("*"," ",str_replace("Ã‘","#",str_replace("Ã±","#",$rowcontrata['apemat']))))))))))))); $direc_per_empre=str_replace("Ã","I",str_replace("Ã“","O",str_replace("`"," ",str_replace(")"," ",str_replace("("," ",str_replace("-"," ",str_replace("Âº"," ",str_replace(","," ",str_replace("."," ",str_replace("?"," ",str_replace("*"," ",str_replace("Ã‘","#",str_replace("Ã±","#",$rowcontrata['direccion']))))))))))))); $nombres=str_replace("Ã","I",str_replace("Ã“","O",str_replace("`"," ",str_replace(")"," ",str_replace("("," ",str_replace("-"," ",str_replace("Âº"," ",str_replace(","," ",str_replace("."," ",str_replace("?"," ",str_replace("*"," ",str_replace("Ã‘","#",str_replace("Ã±","#",$rowcontrata['prinom']." ".$rowcontrata['segnom']))))))))))))); $estciv=$estado_civil; if($profecion!=''){$profis=$profecion;} if($cargoprof!=""){$cargoprofis=$cargoprof;} if($td!="8"){$tipdoc=$td;}}else{$numedoc=""; $nombres=""; $codnacion=""; $estciv=""; $profis=""; $cargoprofis=""; $nombres=""; $feccumpleclie = ""; $autografo=""; if($apemat==""){$apemat=".";}else{$apemat=$apemat;} }
				 ...
				 //aqui coloque 2 de no inscrito pk el sistema no tiene actualizado el inscrito y ede registral ni numeor de partida
				  ...
				  if($representaa!=''){
					  ...
					  $rowrepreaa = mysql_fetch_array($sqldatouif);
					  $rpax=$rowrepreaa['uif'];
					  if($rpax=="R"){$rpa="N";}else{$rpa=$rowrepreaa['uif'];}
					  }
