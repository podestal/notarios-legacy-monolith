...
patrimonial.importetrans, patrimonial.idmon, patrimonial.exhibiomp, patrimonial.fpago, patrimonial.idoppago, patrimonial.idtipoacto, patrimonial.kardex AS 'karpatri' FROM kardex_ro LEFT JOIN patrimonial 
ON kardex_ro.kardex = patrimonial.kardex WHERE (patrimonial.idmon='1' AND patrimonial.importetrans>='7500') OR (patrimonial.idmon='2' AND patrimonial.importetrans>='2500') 
