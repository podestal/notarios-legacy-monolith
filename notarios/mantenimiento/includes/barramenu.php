			...
			function Show()
				{
					...
					if($this->Graba=="1"){$barra = $barra.'<td><button title="grabar" type="button" name="Grabar"   id="Grabar"   value="Grabar" onclick="'.$this->GrabaClick.'"   ><img src="../images/save.png" width="15" height="15" /></button></td>';}
					if($this->Anula=="1"){$barra = $barra.'<td><button title="anular" type="button" name="Anular"   id="Anular"   value="Anular" onclick="'.$this->AnulaClick.'"   ><img src="../images/delete.png" alt="" width="15" height="15" align="absbottom"/></button></td>';}
					if($this->Elimi=="1"){$barra = $barra.'<td><button title="eliminar" type="button" name="Elimi"    id="Elimi"    value="Eliminar" onclick="'.$this->ElimiClick.'"   ><img src="../images/delete.png" width="18" height="18" /></button></td>';}
					if($this->Impri=="1"){$barra = $barra.'<td><button title="reporte" type="button" name="Imprim"   id="Imprim"   value="Imprimir" onclick="'.$this->ImpriClick.'" ><img src="../images/print.png" width="15" height="15" /></button></td>';}
					...
					if(trim($this->itemBusca)!="")
						{
							$barra = $barra.'<td>&nbsp;&nbsp;&nbsp;<select align="absbottom" id="cboBusca" name="cboBusca" value="0" class="text ui-widget-content ui-corner-all" onchange="'.$this->cmbClick.'"><option></option>';
					...
					$barra = $barra.'<td><input type="search" name="txtBuscar" onkeypress="'.$this->onKeytxt.'"  size="'.$this->widthtxt .'" id="txtBuscar" value="'.$_REQUEST["txtBuscar"].'" class="text ui-widget-content ui-corner-all" placeholder="Buscar..."/></td><td><button class="cursor" align="absmiddle" title="buscar" type="button"  name="Buscar"   id="Buscar" value="Buscar"  onclick="'.$this->BuscaClick.'"  >
