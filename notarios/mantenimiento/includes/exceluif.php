<?php
	...
	//Codigo de empresa:
	$codempresa = "CODIGO-EMPRESA";//$_REQUEST["codempresa"];           
	
	//Cod. oficial cumplimiento:
	$codoficum  = "CODIGO-OFICIAL-CUMPLIMIENTO";//$_REQUEST["codoficum"];           
	
	//Perido del reporte:
	$pediodo    = $_REQUEST["fHasta"];//$_GET["fHasta"]; 
