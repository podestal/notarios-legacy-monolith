	...
	if($desc<>""){$sql_servicios =  $sql_servicios." where servicios.descrip like '%$desc%'";}
	
	$sql_servicios = $sql_servicios." order by servicios.descrip asc";
    ...
    while($servicios = mysql_fetch_array($exe_servicios)){
		...
		$arr_servicios[$i][1] = $servicios["descrip"];         
		$arr_servicios[$i][2] = $servicios["tipo"]; 
		$arr_servicios[$i][3] = $servicios["precio1"]; 
		$arr_servicios[$i][4] = $servicios["precio2"]; 
		$arr_servicios[$i][5] = $servicios["grupo"]; 
		$i++; 
    }
         ...
         <tr>
            <td height="76">
                ...
                <table width="548">
                    ...
                    <tr>
                        <td width="68"><span class="titubuskar0">Descripción:</span></td>
            ...
            <td>
                <table width="860" border="1" cellspacing="0" cellpadding="0" >
                        <tr style="background-color:#CCCCCC">
                          <td width="320" align="center"><span class="titubuskar0">Descripción</span></td>
                          <td width="100" align="center"><span class="titubuskar0">Tipo</span></td>
                          <td width="100" align="center"><span class="titubuskar0">Precio 1</span></td>
                          <td width="100" align="center"><span class="titubuskar0">Precio 2</span></td>
                          <td width="100" align="center"><span class="titubuskar0">Grupo</span></td>
                      ...
                      for($j=0; $j<count($arr_servicios); $j++){ ?>
                         <tr id="fila<?php echo $arr_servicios[$j][0]; ?>" >
                            <td align='center'>
                                <span class='reskar'><?php echo $arr_servicios[$j][1]; ?></span>
                            </td>
                            <td align='center'>
                                <span class='reskar'><?php if($arr_servicios[$j][2]=="N") echo "NOTARIALES"; if($arr_servicios[$j][2]=="E") echo "EGRESOS"; ?></span>
                            </td>
                            <td align='center'>
                                <span class='reskar'><?php echo $arr_servicios[$j][3]; ?></span>
                            </td>
                            <td align='center'>
                                <span class='reskar'><?php echo $arr_servicios[$j][4]; ?></span>
                            </td>
                            <td align='center'>
