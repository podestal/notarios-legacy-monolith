...
<form id="frm_mcli" name="frm_mcli" style="width:100%; height:auto "/>
    <table width="580" height="auto"  cellpadding="0" cellspacing="0">
        <tr height="30" style="background-color:#264965">
            <td align="center"><span class='submenutitu' style="font-size:14px">Modificar Impedido</span></td>
        </tr>
        <tr>
        	<td>
            	<table>
                        ...
                        <tr>
                   	  ...
                   	  <td>
                            	<input id="m_tipcliente" name="m_tipcliente" type="checkbox" 
                                <?php 
								if($arr_cliente[37]==1){
       ...
       <tr id="m_filanatural" height="35" style="display:none">
       		<td>
            	<table>
                        ...
                        <tr>
                            ...
                            <td width="197"><input id="m_fecnac" name="m_fecnac" type="text" class="Estilo7" style="width:100px; " readonly="readonly" value="<?php echo $arr_cliente[25];?>" /></td>
        ...
        <tr id="m_filaimpedidos" style="display:none">
            <td>
            	<table width="561">
                      <tr>  
	...
	<span class='submenutitu' style="position:absolute; top:5px; left:555px; cursor:pointer; font-size:14px" title="Cerrar" onClick="cerrar_mimpedido()">x</span></div>
