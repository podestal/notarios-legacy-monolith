...
var _contenido = document.getElementById('contenido').value;	 				 
	...
	ajax.open("POST", "../model/editprotesto.php",true);	
...
<form id="frmescri" name="frmescri" method="post" action="">
            <table width="100%" border="0" >
              <tr>
                <td width="87" align="right" valign="top"><span class="">Descripcion:</span></td>
              ...
              <tr>
                <td width="87" align="right" valign="top"><span class="">Contenido:</span></td>
                <td><textarea name="contenido" id="contenido" cols="35" rows="4" class="text ui-widget-content ui-corner-all"><?php echo $contenido ?></textarea></td>
                </tr>
                <tr>
