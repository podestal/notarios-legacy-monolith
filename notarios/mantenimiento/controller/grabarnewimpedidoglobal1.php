...
echo $apepat=$_REQUEST['apepat'];
echo $apemat=$_REQUEST['apemat'];
echo $prinom=$_REQUEST['prinom'];
echo $segnom=$_REQUEST['segnom'];
echo $concatenar=$apepat.$apemat." ".$prinom.$segnom;
