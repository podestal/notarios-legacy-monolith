...
-->
body{ font-family: Arial, Helvetica, sans-serif; font-size:12px; font-weight: bold; margin-bottom:0px;}
...
<form id="frmescri" name="frmescri" method="post" action="">
            <table width="100%" border="0">
              <tr>
                ...
                <td colspan="3"><input style="text-transform:uppercase;" name="dessello" type="text" class="text ui-widget-content ui-corner-all" id="dessello" size="40" />
                  <span class="Estilo7">
                  <input name="idtipkar" type="hidden" class="text ui-widget-content ui-corner-all" id="idtipkar" size="10" maxlength="1" />
                </span></td>
              </tr>
              <tr>
                <td width="90" align="right" valign="top"><span class="">Contenido:</span></td>
