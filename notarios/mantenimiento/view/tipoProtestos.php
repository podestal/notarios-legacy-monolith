...
<script type="text/javascript" src="../Ajax/diligencias.js" ></script>
...
$(document).ready(function(){ 
	...
	function editkar(){
		...
		$('<iframe id="frame1" class="window-Frame" frameborder="0" src="../controller/EditProtesto.php?idsello='+_idsello+'&dessello='+_dessello+'&contenido='+_contenido+'"/>').dialog({
						autoOpen: true,
						position :["center","top"],
						width   : 450,
						height  : 250,
...
//Elimina datos del tipo de kardex
	...
	{	
		var _idsello = document.getElementById('idsello').value;
		ajax=objetoAjax();
		ajax.open("POST", "../model/elimprotesto.php",true);	
...
<body style="font-size:62.5%;" onLoad="listar_diligencias(1)">
...
width:940px; height:600px;">
    ...
    <table id="title_client" width="100%" bgcolor="#264965" bordercolor="#264965" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td width="745" bgcolor="#264965"><span class="submenutitu">Mantenimiento de Diligencia Protestos</span></td>
        </tr>
    </table>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
 		 <tr>
            <td height="46">
            <div style="border: 1px solid #79B7E7; border-radius: 3px ; background-color:#DDECF7; padding:4px; width:63px; height:20px; cursor:pointer; margin-top:10px; margin-left:22px" title="Nuevo" onClick="nueva_diligencia()">
        ...
        <tr>
			<td valign="top" align="center"><div id="lst_diligencias" style="margin-top:13px"></div></td>
		</tr>
    </table>
    
    <div id="div_ndiligencia" style=" display:none; position:absolute; top:160px; left:218px; width:584px; height:auto; border-radius:10px; -moz-border-radius: 10px;  border: black 1px solid; background-color:white "></div>
  
  <div id="div_mdiligencia" style=" display:none; position:absolute; top:160px; left:218px; width:584px; height:auto; border-radius:10px; -moz-border-radius: 10px;  border: black 1px solid; background-color:white "></div>
