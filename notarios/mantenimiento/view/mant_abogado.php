...
<html lang="es">
<head>
<title>Mantenimiento Abogados</title>
...
<script type="text/javascript" src="../Ajax/abogado_new.js" ></script>
...
<body style=" font-size:63.5%;" onLoad="listar_abogado(1)">
...
width:940px; height:650px;">
	<table id="title_client" width="100%" cellpadding="0" cellspacing="0" height="620">
 	  <tr>
            ...
            <td width="745" bgcolor="#264965"><span class="submenutitu">Mantenimiento de Abogados</span></td>
      </tr>
      <tr>
        	<td></td>
            <td height="46" >
            <div style="border: 1px solid #79B7E7; border-radius: 3px ; background-color:#DDECF7; padding:4px; width:63px; height:20px; cursor:pointer; margin-top:5px; float:left " title="Nuevo" onClick="nuevo_abogado()">
      ...
      <tr height="40">
            <td colspan="2" valign="top">
            	<form id="frm_abogado" name="frm_abogado" method="post" >
                <fieldset id="field_remitente" style=" width:850px; margin-top:0px">
                <legend><span class="Estilo7">Buscar Abogado</span>               </legend>
                <table width="656" height="42" border="0" cellpadding="0" cellspacing="0">
               		<tr>
                    	<td width="80" height="42"><span class="Estilo7" style="margin-left:5px">Abogado</span>: </td>
                        <td colspan="4"><input id="b_abogado" name="b_abogado" type="text" maxlength="120" class="Estilo7" style="width:392px"/></td>
						<td width="112"><input type="button" value="Buscar" class="Estilo7" onClick="listar_abogado(1)"/></td>
                    </tr>
               </table>
               </fieldset>
               </form>
        ...
        <tr height="480">
            <td colspan="2" valign="top" align="center"><div id="lst_abogado" style="margin-top:10px"></div></td>
        </tr>
        
    </table>
   <div id="div_nabogado" style=" display:none; position:absolute; top:160px; left:225px; width:580px; height:auto; border-radius:10px; -moz-border-radius: 10px;  border: black 1px solid; background-color:white; z-index:1 "></div>
   ...
   <div id="div_mabogado" style=" display:none; position:absolute; top:160px; left:225px; width:580px; height:auto; border-radius:10px; -moz-border-radius: 10px;  border: black 1px solid; background-color:white; z-index:1 "></div>
