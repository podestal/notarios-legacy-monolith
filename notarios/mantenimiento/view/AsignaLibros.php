<?php
	...
	$anio=date('Y');
	$query="SELECT count(*)+1 as numlibro FROM libros WHERE ano='$anio'";

	$result = mysql_query($query,$conn);

	$totalRecords = mysql_fetch_assoc($result);
	$numLibro = str_pad($totalRecords['numlibro'], 6, '0', STR_PAD_LEFT);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
// CREA BLOQUES DE KARDEX (VARIOS KARDEX) DEACUERDO AL NUMERO DE KARDEX Y KARDEX INICIAL SELECCIONADOS
	function fcreaBloqueKar()
	{
		...
		ajax.open("POST", "../model/guardaBloqueLibro.php",true);	
    ...
    <tr>
      <td height="30" bgcolor="#264965"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Generar Bloque para libros</span></td>
          <td >&nbsp;</td>
      ...
      <td valign="top"><form id="frmescri" name="frmescri" method="post" action="">
            ...
            <tr>
              <td colspan="2"></td></tr>
              <tr>
                <td width="110" height="22" align="right" ><span class="camposss">Nro de Registros : </span></td>
                ...
                <td height="27" colspan="2" align="left">
                  <table  width="100%">
                    <tr>
                      ...
                      <td width="70%">&nbsp;<input name="num_kinicial" type="text" id="num_kinicial" style="text-transform:uppercase"  value="<?php echo $numLibro;?>" size="15" /></td>
                    </tr>
                  </table>
                </td>
              </tr>
