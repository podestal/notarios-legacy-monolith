...
// CREA BLOQUES DE KARDEX (VARIOS KARDEX) DEACUERDO AL NUMERO DE KARDEX Y KARDEX INICIAL SELECCIONADOS
	function fcreaBloqueKar()
	{
		...
		var vCapacidad = 1;
		if(document.getElementById('rbdIncapaz').checked === true){
			vCapacidad = 2;
		}
		...
		ajax.open("POST", "../model/guardaBloquePCapaz.php",true);	
		...
		ajax.send("num_registros="+_num_registros+"&num_kinicial="+_num_kinicial+"&fec_ingreso="+_fec_ingreso+'&capacidad='+vCapacidad);		
	}
    ...
    <tr>
      <td height="30" bgcolor="#264965"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Generar Bloque para certificado de supervivencia</span></td>
          <td >&nbsp;</td>
            ...
            <tr>
             ...
             <tr>
              ...
              <label></label>
               ...
               <tr>
                <td width="110" height="22" align="right" ><span class="camposss">Persona : </span></td>
                <td width="251" height="22" valign="bottom"><span id="sprytextfield2"> 
                <input type="radio"  id="rbdCapaz" name="rbdPersona" checked=""> Capaz <input id="rbdIncapaz" type="radio" name="rbdPersona"> Incapaz
                </td>
