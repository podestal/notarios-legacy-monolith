...
// CREA BLOQUES DE KARDEX (VARIOS KARDEX) DEACUERDO AL NUMERO DE KARDEX Y KARDEX INICIAL SELECCIONADOS
	function fcreaBloqueKar()
	{
		...
		var _div_loading     = document.getElementById('div_loading');
		
		// Validaciones al crear:
		_div_loading.innerHTML = "<img src='../../images/load.gif'><div>Creando los "+_num_registros+" registros. Espere...</div>";
		document.getElementById('generar').disabled = true;
		
		ajax=objetoAjax();
	
		ajax.open("POST", "../model/guardaBloqueViaje.php",true);	
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4 && ajax.status==200) {
				
				alert('Se guardo El Bloque de '+_num_registros+' Registros satisfactoriamente');
				_div_loading.innerHTML = "";
    ...
    <tr>
      <td height="30" bgcolor="#264965"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Generar Bloque para Viaje</span></td>
          <td >&nbsp;</td>
      ...
      <td valign="top"><form id="frmescri" name="frmescri" method="post" action="">
            ...
            <tr>
              <td colspan="2"></td></tr>
              <tr>
                <td width="82" height="22" align="right" ><span class="camposss">Nro de Registros : </span></td>
                <td width="138" height="22" valign="bottom"><span id="sprytextfield1">
              <label></label>
              ...
              <tr>
                <td height="27" colspan="2" align="left">
                  <table  width="100%">
                    <tr>
                      <td width="37%" align="right"><span class="camposss"></span></td>
                      <td width="63%">&nbsp;<input name="num_kinicial" type="hidden" id="num_kinicial" style="text-transform:uppercase"  value="000001" size="15" /></td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
               ...
               <tr>
                <td align="center" colspan="2"><div style="text-align:center" id="div_loading"></div></td>
              </tr>
          </table>
        </form></td>
    </tr>
