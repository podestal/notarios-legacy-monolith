...
$rowactito = mysql_fetch_array($sqlactito);
    ...
    <td align='center' bgcolor='#FFFFFF'><a href='#' id='".$rowbb['detbien']."' onclick='muesbieneditable(this.id)'><img src='iconos/editamv.png' width='16' height='18'></a></td>
    <td align='center' bgcolor='#FFFFFF'><a href='#' id='".$rowbb['detbien']."' onclick='ElimDetBienes(this.id)'><img src='iconos/eliminamv.png' width='18' height='17'></a></td>
  </tr>";
  }
