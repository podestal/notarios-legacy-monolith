...
num_crono, fecha_crono, num_formu, lugar_formu, observacion,via,fecha_desde,fecha_hasta)
VALUES( NULL, '','$asunto',STR_TO_DATE('$fec_ingreso','%d/%m/%Y'), '$nom_recep', '$hora_recep', '$referencia', '$nom_comu', '$tel_comu', '$email_comu', '$documento', 
'$num_crono', STR_TO_DATE('$fecha_crono','%d/%m/%Y') , '$num_formu', '$lugar_formu', '$observacion','$via','$fecha_desde','$fecha_hasta')";
...
{
	$updatepermiviaje = "UPDATE permi_viaje 
	SET  asunto = '$asunto', 
