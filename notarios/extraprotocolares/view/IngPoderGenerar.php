...
function fGeneraNumPoderQuitar()
{
	...
	$.post("../model/quitaGeneraPoder.php",{ id_poder : _id_poder , num_formu : _num_formu}, function(_response){
  ...
  <tr>
    ...
    <table  width="100%">
        ...
        <tr>
          ...
          <td colspan="3"><div id="div_numcrono" style="width:100px;"><input name="num_crono" type="text" id="num_crono" style="text-transform:uppercase" size="15"  placeholder="Autogenerado" value="<?php if($rowcpermiso['fec_crono']==''){echo "";}else {echo $numkar2;} ?>" /></div></td>
          <td width="51%">&nbsp;</td>
          </tr>
        <tr>
