...
function actualizarContenido(){
    ...
    let newContenidoCarta = contenidoCarta.value.replace('<F>',fechaLetras).replace('<F_N>',fechaentrega).replace('<HORA>',horaentrega.value).replace('<DIRECCION>',dirdestino2.value).replace('<RECEPCION>',recepcion.value)
  ...
  <tr>
    ...
    <table  width="100%">
		...
		<tr>
          ...
          <td width="37%"><input name="numdoc2" type="text" id="numdoc2" style="text-transform:uppercase" onKeyPress="send2(event);" value="<?php echo $rowcarta['dni_destinatario'];?>" size="16" maxlength="15" />&nbsp;
...
<td><select id="firmo" name="firmo">
	<?php echo '<option value="'.$rowcarta['firmo'].'">'.$rowcarta['firmo'].'</option>' ?>
    ...
    <tr>
	    ...
	    <td width="545" height="30" >
	      <textarea name="recepcion" id="recepcion" cols="110" rows="2" onkeypress="return tabulador(this, event);return soloLetrasynumeros(event)" ><?php echo $rowcarta['recepcion'];?></textarea></td>
      
    </tr>
  <tr>
    <td width="183" height="30" valign="top" ><span class="camposss">Contenido:</span>
        <a href="#" onClick="fmuescontenido()"><img src="../../images/help.png" alt="" width="12" height="12" border="0" /></a><br><button onclick="actualizarContenido()">ACTUALIZAR CONTENIDO</button>
        </td>
