...
<title>Listar Legalizaciones</title>
<style type="text/css">
div.frmcartas
{ 
...
<div class="frmcartas">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Legalizaciones</span></td>
        ...
        if($rowu['newdom'] == '1')
              {
                    echo'<a href="AddLegalizacion.php" target="ncartas"><img src="../../iconos/nuevo.png" width="62" height="22" border="0" /></a>';
        }else{
        ...
        ?>
              ...
              <td width="118"><a href="listLegalizaciones.php" target="ncartas"><img src="../../images/search.png" width="22" height="22" border="0" /></a></td>
              </tr>
          </table></td>
          <td width="29">&nbsp;</td>
        </tr>
    ...
    <tr>
      <td align="center"><iframe name="ncartas" src="listLegalizaciones.php" frameborder="0" width="100%" height="800" allowtransparency="true" scrolling="auto"></iframe></td>
    </tr>
  </table>
</div>
</body>
