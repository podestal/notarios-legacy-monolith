    ...
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Legalizaciones de Firmas</span></td>
          <td width="510" align="left"><table width="454" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  if($rowu['newcar'] == '1')
              {
                    echo' <a href="IngLegalizacionView.php" target="ncartas"><img src="../../iconos/nuevo.png" width="62" height="22" border="0" /></a>';
			  }else{
              ...
              <td width="118"><a href="listcartas.php" target="ncartas"><img src="../../images/search.png" width="22" height="22" border="0" /></a></td>
              </tr>
          </table></td>
          <td width="29">&nbsp;</td>
        </tr>
