...
<?php 
	...
	$query   = "SELECT  
				ingreso_cartas.id_carta as cod_carta,
			...
			if($num_carta <> "" ){
				...
				$query = $query." where ingreso_cartas.num_carta  like '%$num_carta%'";
	  ...
	  $query = $query." GROUP BY ingreso_cartas.id_carta ORDER BY ingreso_cartas.id_carta DESC"; 
	  ...
	  {
		$arr_cartas[$i][0] = $cartas["cod_carta"]; 
		$arr_cartas[$i][1] = $cartas["num_carta"]; 
		$arr_cartas[$i][2] = $cartas["fec_ingreso"]; 
		$arr_cartas[$i][3] = $cartas["fec_entrega"]; 
		$arr_cartas[$i][4] = strtoupper($cartas["destinatario"]); 
		$arr_cartas[$i][5] = strtoupper($cartas["remitente"]); 
		$i++; 
	  }
	  ...
	  <table width='840' border='1' cellpadding='0' cellspacing='0' bordercolor='#333333' >
            <tr>
              ...
              <table width='858' cellpadding='0' cellspacing='0' bordercolor='#333333' bgcolor='#CCCCCC'>
                <tr>
                  <td width='63' align='center'><span class='titubuskar0'>N° Carta</span></td>
                  <td width='86' align='center'><span class='titubuskar0'>Fecha Ingreso</span></td>
                  <td width='86' align='center'><span class='titubuskar0'>Fecha Diligencia</span></td>
                  <td width='200' align='center'><span class='titubuskar0'>Remitente</span></td>
                  <td width='238' align='center'><span class='titubuskar0'>Destinatario</span></td>
                </tr>
              </table>
              </td>
            </tr>
		...
		<tr height='20'>
			<td width='63' align='center' >
			    	<span class='reskar'title='Ver' style='color:#06C; cursor:pointer' onclick="ver_cartas('<?php echo $arr_cartas[$j][1]; ?>')"><?php echo formato_crono_agui($arr_cartas[$j][1]); ?></span>
			</td>
			...
			<td width='200' align='center' ><span class='reskar'><?php echo simbolos($arr_cartas[$j][5]); ?></span></td>
