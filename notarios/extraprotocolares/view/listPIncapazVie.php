...
$sql =mysql_query("SELECT * FROM cert_supervivencia WHERE cert_supervivencia.swt_capacidad = 'I'",$conn) or die(mysql_error());
...
<script type="text/javascript" src="../ajax/incapaces.js"></script> 
<title>Listado No Capaces</title>
<style type="text/css">
<!--
.titubuskar {
  font-family: Calibri;
...
<body onload="buscar_incapaces(1);">


<form id="frm_buscarincapaces" name="frm_buscarincapaces" method="post" action="">
        ...
        <tr>
          ...
          <table width="807">
                <tr>
                    ...
                    <td width="91">
                        <span class="titubuskar0">Nombre P. Incapaz:</span>
                    </td>
                    <td width="332">
          ...
          <td>
              <table width="804">
                   <tr>
                      ...
                      <td width="341">
                          <div onclick="buscar_incapaces(1)"><img src="../../iconos/buscarclie.png" width="72" height="29" border="0" /></div>
                      </td>
                    </tr>
                </table>
            </td> 
