...
<tr>
	...
	<td width="27%" align="left"><div id="verqo"><button title="Generarqr" type="button" name="qr"    id="qr" value="qr" onclick="fGenerar();" ><img align="absmiddle" src="../../images/block.png" width="15" height="15" />Generar QR</button></div></td>
