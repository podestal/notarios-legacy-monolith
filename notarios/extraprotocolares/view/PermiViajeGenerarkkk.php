	...
	function fGeneraNumPoderQuitar()
{
	...
	$.post("../model/quitaGeneraViaje.php",{ id_viaje : _id_viaje, num_formu : _num_formu}, function(_response){
  ...
  <tr>
    ...
    <table  width="100%">
        ...
        <tr>
          ...
          <td colspan="3"><div id="div_numcrono" style="width:100px;"><input name="num_crono" type="text" id="num_crono" style="text-transform:uppercase" value="<?php if($rowcpermiso['fecha_crono']=='' or $rowcpermiso['eval_fechacrono']=='0000-00-00' or $rowcpermiso['eval_fechacrono']=='00/00/0000'){echo "";}else {echo $numkar2;} ?>" size="15" readonly="readonly" placeholder="Autogenerado" /></div></td>
          <td width="51%">&nbsp;</td>
          </tr>
        <tr>
