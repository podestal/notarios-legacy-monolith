...
$sql =mysql_query("SELECT * FROM sellosviajes",$conn) or die(mysql_error());
...
<script type="text/javascript">
	...
	document.getElementById('observacionG').value = contenido2;
	...
	function fbusdetallecarta() { fbussello2();	}
	
	function pasadatos()
	{
		var _obs = document.getElementById('contecarta2').value;
		document.getElementById('observacionG').value = _obs;	
	}
...
$consulkar=mysql_query("Select * from sellosviajes", $conn) or die(mysql_error());
