...
<!-- aca empieza la webada-->
	<table>
    <input type="hidden" name="idClienteSolicitante" id="idClienteSolicitante" value="<?php echo $row['idcliente'];?>">
        <tr>
          <td width="14%"><span class="camposss">Solicitante:</span></td>
          <td colspan="3"><input name="nnombre_solic" type="text" id="nnombre_solic" style="text-transform:uppercase" size="100" maxlength="400" onkeypress="return soloLetras(event)" value="<?php echo $row['nombre'];?>"/>
        ...
        <tr>
          ...
          <td colspan="3"><input name="domic_solic" type="text" id="domic_solic" style="text-transform:uppercase" size="100" maxlength="2000"  placeholder="Direccion" value="<?php echo $row['direccion'];?>"/>
		...
		?>
          ...
          <td colspan="3"><input name="distrito_solicc" value="<?php echo $res['coddis'];?>" type="hidden" id="distrito_solicc" size="15" />
            <table width="522" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="428"><input name="ubigen" type="text" value="<?php echo $res['descripcion'];?>" id="ubigen" size="60" onKeyUp="return validacion4(this)"  /></td>
    ...
    <td height="30" colspan="3"><table width="466" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="254"><label>
          <input name="profesion" value="<?php echo $row['detaprofesion'];?>" style="text-transform:uppercase"  type="text" id="nomprofesionesc2" size="40"   />
           <input name="nomprofesionesc2" value="<?php echo $row['idprofesion'];?>" style="text-transform:uppercase"  type="hidden" id="hdnnomprofesionesc2" size="40"   />
        </label></td>
   ...
   <tr>
    ...
    <input name="idestcivill" type="hidden" id="idestcivill" value="<?php echo $rowcicil['idestcivil'];?>" style="background:#FFFFFF; text-transform:uppercase" size="50" onkeypress="buscaprofesionesc()" />
</td>
  </tr>
  <tr>
