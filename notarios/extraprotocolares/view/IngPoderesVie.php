...
// #= Imprime Ingreso poderes.
  ...
  function fImprimirqr()
    ...
    var reply=confirm("IMPORTANTE \n ANTES DE GENERAR EL QR SE RECOMIENDA VERIFICAR QUE LA INFORMACIÓN INGRESADA EN EL INSTRUMENTO SEA LA CORRECTA, CREADO EL QR ESTE NO PODRÁ SER MODIFICADO.  \n  ¿Desea continuar?")
		...
		if(_tip_poder=='003')
			{		
				$.post("../../reportes_word/generador_poderONPqr.php",_data,function(_respuesta){
							alert(_respuesta);
						});
			}
		...
		// #= PODER ESSALUD:		
			...
			{		
				$.post("../../reportes_word/generador_poder_essaludqr.php",_data,function(_respuesta){
							alert(_respuesta);
						});			
			}	
		...
		// #= PODER FUERA DE REGISTRO:			
			...
			{
				$.post("../../reportes_word/generador_poder_fueraregistroqr.php",_data,function(_respuesta){
							alert(_respuesta);
						});
			}			
...
<tr>
    ...
    <td width="27%" align="left"><div id="verqo"><button title="Generarqr" type="button" name="qr"    id="qr" value="qr" onclick="fImprimirqr();" ><img align="absmiddle" src="../../images/block.png" width="15" height="15" />Generar QR</button></div></td>
          ...
          <td colspan="4"><table  width="100%">
            ...
            <tr>
              ...
              <td width="20%" align="right"><span class="camposss">
                Hora:</span></td>
              <td width="27%"><input name="hora_recep" type="text" id="hora_recep" style="text-transform:uppercase" onkeypress="return tabulador(this, event);return solonumeros(event)" value="<?php echo date("H:i"); ?>" size="10" maxlength="10"  />
                </td>
              <td width="6%">&nbsp;</td>
              <td width="16%">&nbsp;</td>
            </tr>
...
?>
        ...
        <tr>
          ...
          <td width="10%"><input name="fec_ingreso" type="text" class="tcal" id="fec_ingreso" style="text-transform:uppercase" onKeyUp = "this.value=formateafecha(this.value);"  onkeypress="return tabulador(this, event);" value="<?php echo date("d/m/Y"); ?>" size="10" maxlength="10" /></td>
          <td width="14%" align="right"><span class="camposss">Referencia:</span></td>
          <td width="57%"><input name="referencia" type="text" id="referencia" style="text-transform:uppercase" size="50" maxlength="900"onkeypress="return tabulador(this, event);return soloLetras(event)"/></td>
          </tr>
        <tr>
          <td><span class="camposss">Comunicarse con:</span></td>
          <td><input name="nom_comuni" type="text" id="nom_comuni" style="text-transform:uppercase" size="30" maxlength="400" onkeypress="return tabulador(this, event);return soloLetras(event)"  /></td>
          <td align="right"><span class="camposss">Telefono:</span></td>
          <td><input name="telf_comuni" type="text" id="telf_comuni" style="text-transform:uppercase" size="10"onkeypress="return tabulador(this, event);return solonumeros(event)" maxlength="15" /></td>
        </tr>
        <tr>
          <td><span class="camposss">Email:</span></td>
          <td><input name="email_comuni" type="text"  id="email_comuni"  size="30" maxlength="400" placeholder="ejemplo@dominio.com" onkeypress="return tabulador(this, event);" /></td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          ...
          <td colspan="3">
<input name="id_respon" type="text" id="id_respon" style="text-transform:uppercase" value="<?php echo $_SESSION["apepat_usu"].' '.$_SESSION["nom1_usu"]; ?>" size="60" readonly maxlength="400" onkeypress="return tabulador(this, event);return soloLetras(event)" />
&nbsp;
<input name="documento" type="hidden" id="documento" style="text-transform:uppercase" value="0.00" size="20" />
	<input name="num_kardex" type="hidden" id="num_kardex" size="15" readonly  placeholder="Autogenerado"/>
    <input name="idasunto" type="hidden" id="idasunto" style="text-transform:uppercase" size="2" readonly /><input name="des_asunto" type="hidden" id="des_asunto" style="text-transform:uppercase" size="2" readonly />
    <input name="nom_recep" type="hidden" id="nom_recep" style="text-transform:uppercase" size="15" />
