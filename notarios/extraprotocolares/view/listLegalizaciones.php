...
<!---->
<body onload="buscarLegalizacion(1)">
    ...
    <td colspan="2">
        ...
        <table width="837" border="0" cellspacing="0" cellpadding="0" >
            ...
            <tr>
                ...
                <td width="54"><span class="titubuskar0">Fecha Inicio: </span>
                </td>
                <td width="122">
                  <input id="rango1" name="rango1" type="text" class="tcal"   size="10" readonly="readonly" />
                </td>
                <td width="53"><span class="titubuskar0">Fecha Fin: </span>
                </td>
                <td width="91">
                  <input id="rango2" name="rango2" type="text" class="tcal" size="10" readonly="readonly"/>
                </td>
                <td width="119">
                  <a onclick="buscarLegalizacion(1)"><img src="../../iconos/buscarclie.png" width="72" height="29" border="0" /></a>
                </td>
            </tr>
        </table>
        </form>
