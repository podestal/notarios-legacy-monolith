...
?></td>
        ...
        <tr>
          ...
          <td colspan="3"><input name="nnombre_soli" type="text" id="nnombre_soli" onkeyup="editnnombre_solic();" style="text-transform:uppercase" value="<?php 
        ...
        <tr>
          ...
          <td colspan="3"><input name="ndireccion_soli" type="text" id="ndireccion_soli" onkeyup="editndireccion_solic();" style="text-transform:uppercase" value="<?php 
...
?></td>
        ...
        <tr>
          <td colspan="4"><input name="nrepresentacion_soli" type="text" id="nrepresentacion_soli" onkeyup="editnrepresentacion_solic();" style="text-transform:uppercase" value="<?php 
		   $c_desc = $rowpart['representante'];
		  $textorpat=str_replace("?","'",$c_desc);
		  $textoamperpat=str_replace("*","&",$textorpat);
		  echo strtoupper($textoamperpat); ?>" size="100" maxlength="500" />
          <input type="hidden" name= "representacion_soli" id="representacion_soli" />
          </td>
          </tr>
        <tr>
          ...
          <td colspan="3"><input name="int_legitimo_soli" type="text" id="int_legitimo_soli" style="text-transform:uppercase" value="<?php echo $rowpart['tercero']; ?>" size="84" maxlength="500" /></td>
            ...
            <tr>
                <td colspan="2"><label><input type="hidden" name="id_cambio" id="id_cambio" value="<?php echo $rowpart['id_cambio']; ?>" />
                  <input type="hidden" name="id_solicitante" id="id_solicitante" value="<?php echo $rowpart['id_solicitante'] ?>" />
                </label></td>
              </tr>
        </table>
</div>
