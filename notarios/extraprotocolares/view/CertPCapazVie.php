...
<div class="frmcartas">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Certificado de Supervivencia - Persona Capaz</span></td>
          <td width="510" align="left"><table width="454" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  if($rowu['newcap'] == '1')
              {
                    echo'<a href="PCapazVie.php" target="ncartas"><img src="../../iconos/nuevo.png" width="62" height="22" border="0" /></a>';
			  }else{
              ...
              <td width="118"><a href="listPCapazVie.php" target="ncartas"><img src="../../images/search.png" width="22" height="22" border="0" /></a></td>
              </tr>
          </table></td>
          <td width="29">&nbsp;</td>
        </tr>
    ...
    <tr>
      <td align="center"><iframe name="ncartas" src="listPCapazVie.php" frameborder="0" width="100%" height="800" allowtransparency="true" scrolling="auto"></iframe></td>
    </tr>
  </table>
</div>
</body>
