...
<script type="text/javascript" src="../../tcal.js"></script> 
<script type="text/javascript" src="../includes/js/IngLegalizacionView.js"></script> 
...
function actualizarContenido(){
    ...
    let newContenidoCarta = contenidoCarta.replace('<F>',fechaLetras).replace('<F_N>',fecentrega.value).replace('<HORA>',horaentrega.value).replace('<DIRECCION>',dirdestino2.value)
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr>
    <td colspan="2"><table  width="100%">
      <tr>
        <td colspan="6"><div id="muesguarda" title="Confirmacion" style="display:none">Desea guardar la Certificacion de Firma..?</div><div id="confirmaGuarda"></div></td>
        </tr>
      <tr>
  ...
  <tr>
    ...
    <legend><span class="camposss">Contraparte</span></legend>
    <table  width="100%">
		<tr>
          <td><span class="camposss">T.documento :</span></td>
          <td><label for="select"></label>
