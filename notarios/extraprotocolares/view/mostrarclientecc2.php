<table width="100%">
        <tr>
          ...
          <td colspan="3"><input name="nombre" type="text" id="nombre" style="text-transform:uppercase" value="<?php echo $row['razonsocial']; ?>" size="60" maxlength="400" onkeypress="return soloLetras(event)"/>
            </td>
          </tr>
        
        <tr>
          <td><span class="camposss">Domicilio:</span> </td>
          <td colspan="3"><input name="direccion" type="text" id="direccion" style="text-transform:uppercase" value="<?php echo $row['domfiscal']; ?>" size="60" maxlength="2000" /></td>
        </tr>
        <tr>
