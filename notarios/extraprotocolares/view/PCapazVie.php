...
<script type="text/javascript" src="ajaxcapaz.js"></script> 
  ...
  <tr>
    <td ><table  width="100%">
      ...
      <tr>
        ...
        <td width="20%"><input name="num_formu" type="text" id="num_formu" onkeypress="return tabulador(this, event);return solonumeros(event)" style="text-transform:uppercase" size="15" /></td>
        </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <table  width="100%">
        <tr>
          ...
          <td width="45%" colspan="-1"><input name="documento" type="hidden" id="documento" style="text-transform:uppercase" size="15" /></td>
        </tr>
       
        <tr>
          <td width="13%"><span class="camposss">Identificado con:</span></td>
          <td width="25%"><?php 
			$oCombo = new CmbList()  ;					 		
...
?></td>
          ...
          <td colspan="-1"><input  name="numdocu" type="text" id="numdocu" style="text-transform:uppercase" size="15" maxlength="20" placeholder="N. documento" onkeyup="docc();" onkeypress="send(event);" />&nbsp;&nbsp;&nbsp;
          <span class="camposss">
          <input  name="num_docu" type="hidden" id="num_docu" style="text-transform:uppercase" size="15" maxlength="20" placeholder="N. documento"    />
...
?></td>
          ...
          <td><input name="ndocu_testigo" type="text" id="ndocu_testigo" style="text-transform:uppercase" size="15" maxlength="20" placeholder="N. documento" onkeypress="return tabulador(this, event);return solonumeros(event)" /></td>
        </tr>
        <tr>
          <td colspan="4"><span class="camposss">Testigo a ruego: 
            <input name="nnom_testigo" type="text" id="nnom_testigo" style="text-transform:uppercase" size="80" maxlength="400" onKeyUp="testigo();" onkeypress="return tabulador(this, event);return soloLetras(event)"/>
