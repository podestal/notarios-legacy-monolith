// JavaScript Document
	...
	function verLegalizaciones(idLegalizacion)
	{
			document.location.href="AddLegalizacion.php?idLegalizacion="+idLegalizacion;
	
	}
	
	function buscarLegalizacion(page){
		...
		if(flag ==1){
		   ...
		   var campos =$("frm_buscardomiciliarios").serialize();
		   new Ajax.Updater("lista_domiciliarios", "busquedaLegalizacion.php?" + campos+"&pag=" + page);
			
		   limpiarActasPremiadas();
    	}
		if(flag ==2){
			//alert("No Ejecuta operacion"); 
		}
