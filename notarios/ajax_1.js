...
function actualizarkardex()
{
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	ajax.send("idtipkar="+idtipkar+"&kardexconexo="+kardexconexo+"&nreferencia="+nreferencia+"&codactos="+codactos+"&contrato="+contrato+"&dregistral="+dregistral+"&dnotarial="+dnotarial+"&idnotario="+idnotario+"&codkardex="+codkardex+"&fechaingreso="+fechaingreso+"&idabogado="+idabogado+"&responsable_new="+responsable_new+"&ob_nota="+ob_nota+"&ins_espec="+ins_espec+"&idusuarios="+idusuarios+"&funcionario_new="+funcionario_new)
...
function updatekardex()
{
	...
	var fechaminuta  = document.getElementById('fechaminuta').value;
		...
		if(fechaescritura!=''){
			...
			if(numescritura!=''){
				...
				}else{alert('Faltan ingresar Escritura');return;}
			
			} else {alert('Faltan ingresar Fecha de Escritura');return;}
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	ajax.send("fechaconclusion="+fechaconclusion+"&folioini="+folioini+"&foliofin="+foliofin+"&papelini="+papelini+"&papelfin="+papelfin+"&numminuta="+numminuta+"&numescritura="+numescritura+"&fechaescritura="+fechaescritura+"&codkardex="+codkardex+"&tomo="+tomo+"&registro="+registro+"&fechaminuta="+fechaminuta)
...
function editarmovreg()
{
	...
	var codkardex	  = document.frmprotocolares.codkardex.value;
	var fechamov2	  = document.frmprotocolares.fechamov2.value;
	var vencimiento2  = document.frmprotocolares.vencimiento2.value;
	var idsedereg2	  = document.frmprotocolares.idsedereg2.value;
	var idsecreg2	  = document.frmprotocolares.idsecreg2.value;
	var titulorp2	  = document.frmprotocolares.titulorp2.value;
	var idtiptraoges2 = document.frmprotocolares.idtiptraoges2.value;
	var idestreg2	  = document.frmprotocolares.idestreg2.value;
	var importee2	  = document.frmprotocolares.importee2.value;
	var codusuario2	  = document.frmprotocolares.codusuario2.value;
	var anotacion2	  = document.frmprotocolares.anotacion2.value;
	var codmovreg	  = document.frmprotocolares.codmovreg.value;
	var numeroo2	  = document.frmprotocolares.numeroo2.value;
	var observa2	  = document.frmprotocolares.observa2.value;
	var conestado2    = document.frmprotocolares.conestado2.value;
	var itemcodmovreg = document.frmprotocolares.itemcodmovreg.value;
...
function buscaclientes()
{
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	ajax.send("tipoper="+tipoper+"&tipodoc="+tipodoc+"&numdoc="+numdoc+"&image="+vimageCaptcha+"&consult_sunat_reniec="+consultReniecSunat);
}
