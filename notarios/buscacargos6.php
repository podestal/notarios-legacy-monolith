...
$buscacargooss6=$_POST['buscacargooss6'];
...
echo"<table width='550' border='1' cellpadding='0' cellspacing='0' bordercolor='#B0B0B0' ba>
  <tr>
    ...
    <td width='89'><a href='#' id='".$rowbuspro['idcargoprofe']."' name='".$rowbuspro['descripcrapro']."' onclick='mostrarcargoos6(this.id,this.name)'><img src='iconos/seleccionar.png' width='94' height='29'></a></td>
  </tr>
</table>";
