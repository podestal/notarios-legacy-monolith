...
$nomrepor = "GARANTIAS MOBILIARIAS";
...
function Header(){
 ...
 //$this->Image('images/1.png',10,8,40);
  ...
  $this->Cell(30,10,'INDICE ALFABETICO DE GARANTIAS MOBILIARIAS',0,0,'C');// Titulo de acuerdo a los parametros
...
$cabecera=array('Contratantes','Fecha Escr.','Kardex','Acto','N.Escritura','N.Folio');
...
$pdf4=new PDF('L','mm','A4');
$pdf4->AliasNbPages();
$pdf4->AddPage();
$pdf4->SetFont('Times','',7);
$pdf4->mysql_tabla($cabecera,$anchos,$data,$alineaciones);
$pdf4->Output();
