<?php
 /*
 * Commentarios   : Reporte Alfabetico
 * Fecha Creacion : 
 * Creado por     :
 * Actualización  :
 * Observación    : 
...
function Header(){
 ...
 //$this->Image('images/1.png',10,8,40);
  ...
  $this->Cell(30,10,'INDICE ALFABETICO DE ESCRITURAS PUBLICAS',0,0,'C');// Titulo de acuerdo a los parametros
...
UPPER(kardex.contrato), kardex.numescritura, kardex.numminuta, kardex.folioini
FROM kardex
...
$cabecera=array('Contratantes','Fecha Escr.','Kardex','Acto','N.Escritura','N.Minuta','N.Folio');
$anchos=array(80,13,15,100,15,15,15);
$alineaciones=array('L','L','C','L','L','L','L');
