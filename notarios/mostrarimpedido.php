  ...
  <tr>
    ...
    <td width="725"><div id="tipocondicionk" class="tipoacto" style="overflow:auto;"></div></td>
      ...
      <tr>
        ...
        <td height="30"><input type="text" name="prinom" style="text-transform:uppercase" id="prinom" value="<?php $textorpri=str_replace("?","'",$row['prinom']);
      ...
      <tr>
                    ...
                    <tr>
                     <td height="25" colspan="2"><table width="600" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="172"><select name="inscrito" id="inscrito" onChange="verificarsi(this.value)">
                       ...
                       <tr>
                          <td height="8" colspan="4"><div id="verinscrit" style="display:none;">
        ...
        <div><table width="642" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="7" class="impedido">ESTA PERSONA ESTA IMPEDIDA DE CONTRATAR</td>
            </tr>
          <tr>
            <td width="104">&nbsp;</td>
            <td colspan="6"><span class="impedido2"><?php  echo strtoupper($row['impmotivo']); ?>
              <?php  echo strtoupper($row['impeingre']); ?>
              <?php  echo strtoupper($row['impeorigen']); ?>
            </span></td>
            </tr>
          </table></div>
          <span class="camposss">
