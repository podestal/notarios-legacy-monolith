...
$consult = mysql_query("SELECT usuarios.idusuario, usuarios.apepat, usuarios.apemat, usuarios.prinom, usuarios.segnom, usuarios.loginusuario, usuarios.estado, cargousu.descargo FROM usuarios inner join cargousu on usuarios.idcargo=cargousu.idcargo WHERE prinom LIKE '%".$nombre."%'", $conn) or die(mysql_error());
