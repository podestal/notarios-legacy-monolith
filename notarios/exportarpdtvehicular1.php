...
function showValidationPdt()
	{
		...
		window.open('pdt/frm_vehicular.php?initialDate='+_desde+'&finalDate='+_hasta);			
	}	
    ...
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">PDT Vehiculares</span></td>
    ...
    <tr>
      <td align="center">
        <table width="740" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="27" colspan="4"><span style="font-family:Verdana, Geneva, sans-serif; font-size:14px; color:#036;"><strong>Vehiculares</strong></span></td>
            </tr>
          <tr>
