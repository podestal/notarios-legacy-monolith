...
echo"<TR><td class='cualquierotroestilo' width='90'  align='center' valign='top'><span class='Estilo12'>"; $time=explode("-",$row['fechaescritura']); echo $time[2] . "/" . $time[1] . "/" . $time[0]; 
	 echo"&nbsp;</span></td>
    <td class='cualquierotroestilo' width='75'  align='center' valign='top'><span class='Estilo12'>".$row['kardex']."</span></td>
	
    <td class='cualquierotroestilo' width='150'   align='center' valign='top'><span class='Estilo12'>"; 
	...
	echo"</span></div></td>
   <td class='cualquierotroestilo' width='80'   align='center' valign='top'><span class='Estilo12'>".strtoupper($row['contrato'])."</span></td>
