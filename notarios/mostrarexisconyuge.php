  ...
  <tr>
    ...
    <td height="30" colspan="3"><table width="412" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="223"><a href="#" id="exisconyuge" onClick="mostrar_desc('buscaubisc44')"><img src="iconos/seleccionar.png" width="94" height="29" border="0" /></a>
              <div id="buscaubisc44" style="position:absolute; display:none; width:637px; height:223px; left: -8px; top: 146px; z-index:20; background:#CCCCCC; border: 1px solid #333333; border: 1px solid #264965; -moz-border-radius: 13px; -webkit-border-radius: 13px; border-radius: 13px; -moz-box-shadow: 0px 0px 5px #000000; -webkit-box-shadow: 0px 0px 5px #000000; box-shadow: 0px 0px 5px #000000;">
                <table width="637" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="24" height="29">&nbsp;</td>
                    <td width="585"><span class="camposss">Seleccionar Ubigeo:</span></td>
                    <td width="28"><a href="#" onClick="ocultar_desc('buscaubisc44')"><img src="iconos/cerrar.png" width="21" height="20" border="0" /></a></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><label>
                      <input name="buscaubisc4" type="text" id="buscaubisc4"  style="background:#FFFFFF; text-transform:uppercase;" size="50" onKeyPress="buscaubigeossc4()" />
                    </label></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
...
?>
  ...
  <tr>
    ...
    <td height="30" colspan="3"><table width="410" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="129"><a href="#" id="buscaprofis" onClick="mostrar_desc('buscaprofe4')"><img src="iconos/seleccionar.png" width="94" height="29" border="0" /></a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td height="30" colspan="3"><table width="409" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="128"><a href="#" id="buscacargooooooo" onClick="mostrar_desc('buscacargooo4')"><img src="iconos/seleccionar.png" width="94" height="29" border="0" /></a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="30">&nbsp;</td>
    <td height="30"><input name="codubisc4" type="hidden" id="codubis4" size="15" value="<?php echo $rowclc['idubigeo'];  ?>" />
