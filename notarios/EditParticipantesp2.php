...
$consulcontratantes = mysql_query("SELECT * FROM protesto_participantes WHERE protesto_participantes.id_protesto='$id_poder' AND protesto_participantes.id_participante = '$id_contrata' and protesto_participantes.anio='$anio'", $conn) or die(mysql_error());
...
<script type="text/javascript">
	...
	function ActDivContratantes()
	{
		...
		var _anio = $("#anio").val()
		$("#div_pcontratantes").load("PoderContratantes.php", {id_poder : _id_poder, anio : _anio}, function(){
...
<form id="frmescri" name="frmescri" method="post" action="">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="251" height="45" valign="bottom">
                  <input name="c_codcontrat" type="text"  id="c_codcontrat" style="text-transform:uppercase;"  value="<?php echo $rowpart['num_docparti']; ?>" readonly />
                </td>
              ...
              <tr>
                ...
                <td height="27"><span class="titus33">
                  <input name="c_descontrat" type="text"  id="c_descontrat" style="text-transform:uppercase;"  onkeyup="grab1();" value="<?php $c_desc = $rowpart['descri_parti'];
					$textorpat=str_replace("?","'",$c_desc);
					$textoamperpat=str_replace("*","&",$textorpat);
					echo strtoupper($textoamperpat); ?>" size="40" maxlength="3000" />
 ...
 ORDER BY des_condicionp ASC"; 
			...
			$oCombo->selected   = $rowpart['tip_condi'];
			$oCombo->Show();
			$oCombo->oDesCon(); 
?></td>
              </tr>
              <tr>
                <td height="28">&nbsp;</td>
                <td height="28"><label><input type="hidden" name="id_poder" id="id_poder" value="<?php echo $rowpart['id_protesto']; ?>" />
                  <input type="hidden" name="id_contrata" id="id_contrata" value="<?php echo $rowpart['id_participante']; ?>" /> <input type="hidden" name="anio" id="anio" value="<?php echo $rowpart['anio']; ?>" />
                </label></td>
              </tr>
              <tr>
