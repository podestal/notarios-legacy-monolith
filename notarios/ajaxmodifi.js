...
ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
//enviando los valores
ajax.send("codkardex="+codkardex+"&tipob="+tipob+"&tipobien="+tipobien+"&codubis="+codubis+"&fechaconst="+fechaconst+"&oespecific="+oespecific+"&smaquiequipo="+smaquiequipo+"&tpsm="+tpsm+"&npsm="+npsm+"&itemmpp="+itemmpp)
...
function saveformulario()
{
	...
	idrenta=document.getElementById('idrenta').value;
	ajax=objetoAjax();
...
/////////aqui copiar esta funcion  para ajax.js
