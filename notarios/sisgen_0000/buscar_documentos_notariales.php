...
//********************************************************************* */
	...
	WHERE (cx.uif ='O' OR cx.uif='B' OR cx.uif='G' OR cx.uif='N' OR cx.uif='R') AND cl.tipper='J'") or die(mysqli_error());
	...
	WHERE (cx.uif ='O' OR cx.uif='B' OR cx.uif='G' OR cx.uif='N' OR cx.uif='R') AND cl.tipper='N'") or die(mysqli_error());
