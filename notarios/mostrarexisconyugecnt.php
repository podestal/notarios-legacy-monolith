...
<table width="598" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="30"><select name="idestcivil6" id="idestcivil6" onChange="">
      <?php 
  ...
  <tr>
    ...
    <td height="30"><select name="nacionalidad6" id="nacionalidad6" style="width:150px;">
  ...
  <tr>
    ...
    <td height="30"><a href="#" onclick="ggclie6mm()"><img src="iconos/grabar.png" width="94" height="29" border="0" /></a></td>
    <td height="30">&nbsp;</td>
    <td height="30"><input name="codubisc6" type="hidden" id="codubis6" size="15" value="<?php echo $rowclc['idubigeo'];  ?>" />
        ...
        <input name="codclie6" type="hidden" id="codclie6" size="15" value="<?php echo $rowclc['idcontratante'];  ?>" />
        <input name="codclie6n" type="hidden" id="codclie6n" size="15" value="<?php echo $rowclc['idcliente'];  ?>" /></td></td>
  </tr>
</table>
