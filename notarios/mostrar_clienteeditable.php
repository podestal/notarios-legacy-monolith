...
<table width="598" border="0" cellspacing="0" cellpadding="0">
 ...
 ?>" size="60" />
  ...
  <tr>
    ...
    <td height="30" colspan="2" align="left"><div id="ccconyuge2"><input name='cconyuge6' type='hidden' value='<?php echo $rowclientte['conyuge'];  ?>' /></div></td>
  </tr>
  <tr>
    <td height="30">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="30"><label>
      <input name="numdoc3" style="background:#FFFFFF" type="hidden"  id="numdoc3" size="20" value="<?php echo $rowclientte['numdoc'];  ?>" />
    </label></td>
  </tr>
  <tr>
    <td height="30">&nbsp;</td>
    <td height="30" align="right"><span class="camposss">Nacionalidad :</span></td>
    <td height="30"><select name="nacionalidad3" id="nacionalidad3" style="width:150px;" >
      
      <?php
	  
	     $sqlnacc=mysql_query("select * from nacionalidades where  idnacionalidad='".$rowclientte['nacionalidad']."'", $conn) or die(mysql_error());
        $rownacc=mysql_fetch_array($sqlnacc);
		echo "<option value = ".$rownacc["idnacionalidad"]." selected='selected'>".nl2br($rownacc["descripcion"])."</option>";  
  ...
  <tr>
    ...
    <td height="30" colspan="3"><table width="410" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="281"><label>
          <input name="nomprofesiones3" readonly="readonly" style="text-transform:uppercase; background:#FFFFFF" type="text" id="nomprofesiones3" size="45" value="<?php echo $rowclientte['detaprofesion'];  ?>" />
        </label></td>
  ...
  <tr>
    ...
    <td height="30">&nbsp;</td>
    <td height="30"><input name="codubisc3" type="hidden" id="codubis3" size="15" value="<?php echo $rowclientte['idubigeo'];  ?>" />
