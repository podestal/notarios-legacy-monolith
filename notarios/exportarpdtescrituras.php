...
function showValidationPdt()
	{
		...
		window.open('pdt/frm_escritura.php?initialDate='+_desde+'&finalDate='+_hasta);			
	}	
    ...
    <tr>
      <td align="center">
        <table width="740" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="27" colspan="4"><span style="font-family:Verdana, Geneva, sans-serif; font-size:14px; color:#036;"><strong>Escritura</strong></span></td>
            </tr>
          <tr>
