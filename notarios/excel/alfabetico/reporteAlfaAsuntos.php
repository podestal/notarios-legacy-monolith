<?php
	...
	if($_POST['fechade']!="" or $_POST['fechaa']!="") {
		...
		header("Content-Disposition: attachment; filename=INDICE_ALFABETICO_NO_CONTENCIOSOS_".$fecha2[2].".".$extension);
	...
	<table border='0' cellpadding='0' cellspacing='0'>
		<tr>
			<td colspan="4" align="center" style="font-size:18.5px"><b>INDICE ALFABETICO - REGISTRO DE PROCESOS NO CONTENCIOSOS</b></td>
		</tr>
		<tr>
