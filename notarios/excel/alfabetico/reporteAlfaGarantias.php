<?php
	...
	if($_POST['fechade']!="" or $_POST['fechaa']!="") {
		...
		header("Content-Disposition: attachment; filename=INDICE_ALFABETICO_GARANTIAS_MOBILIARIAS_".$fecha2[2].".".$extension);
		...
		$queryKardex = "SELECT fechaescritura,
						...
						WHERE k.idtipkar='4' and nc=0 and fechaescritura <> '' 
	...
	<table border='0' cellpadding='0' cellspacing='0'>
		<tr>
			<td colspan="4" align="center" style="font-size:18.5px"><b>INDICE ALFABETICO - CONSTITUCION DE GARANTIAS MOBILIARIAS</b></td>
		</tr>
		<tr>
	...
	echo "<script>window.location='../../indicecrogarantiasalfa.php'</script>";	
}
?>