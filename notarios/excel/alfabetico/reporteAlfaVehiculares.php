...
header("Content-Disposition: attachment; filename=INDICE_ALFABETICO_DE_TRANSFERENCIAS_VEHICULARES_".$fecha2[2].".".$extension);
...
<tr>
	<td colspan="4" align="center" style="font-size:18.5px"><b>INDICE ALFABETICO - TRANSFERENCIAS VEHICULARES</b></td>
</tr>
<tr>
...
while($row = mysql_fetch_array($consulta)){
 ...
 foreach($indicesOrdenados as $value){
	 $html = "<tr>";
		 ...
		 $html .= "<td style='white-space: nowrap;' align='right'>".$value['placa']."&nbsp;</td>";
...
<?php
	...
	echo "<script>window.location='../../indicecrovehicularalfa.php'</script>";	
}
?>
