...
if($_POST['fechade']!="" or $_POST['fechaa']!="") {
	...
	header("Content-Disposition: attachment; filename=INDICE_CRONOLOGICO_TESTAMENTOS_".$fecha2[2].".".$extension);
...
<tr>
	<td colspan="6" align="center" style="font-size:18.5px"><b>INDICE CRONOLOGICO - TESTAMENTOS</b></td>
