<?php
	...
	if($_POST['fechade']!="" or $_POST['fechaa']!="") {
		...
		header("Content-Disposition: attachment; filename=INDICE_CRONOLOGICO_ESCRITURAS_PUBLICAS_".$fecha2[2].".".$extension);
	...
	<table border='0' cellpadding='0' cellspacing='0'>
		<tr>
			<td colspan="7" align="center" style="font-size:18.5px"><b>INDICE CRONOLOGICO - REGISTRO DE ESCRITURAS PUBLICAS</b></td>
		</tr>
		<tr>
