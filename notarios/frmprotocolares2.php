...
<div class="frmprotocolar">
  <table width="900" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="510" align="left"><table width="454" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  if($rowu['newkar'] == '1')
              {
                    echo'<a href="protocolares.php?tipoid=2" target="protocolar"><img src="iconos/nuevo.png" width="62" height="22" border="0" /></a>';
			  }else{
              ...
              <td width="118"><a href="listadokardex2.php" target="protocolar"><img src="iconos/buscar.png" width="80" height="22" border="0" /></a></td>
              </tr>
          </table></td>
          <td width="29">&nbsp;</td>
        </tr>
    ...
    <tr>
      <td align="center"><iframe name="protocolar" src="listadokardex2.php" frameborder="0" width="880" height="800" allowtransparency="true" scrolling="auto"></iframe></td>
    </tr>
  </table>
</div>
</body>
