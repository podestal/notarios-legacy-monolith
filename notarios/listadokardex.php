...
<body onload="buscar_kardex(1,<?php echo $tipoescritura; ?>)">
    ...
    <td colspan="2">
      ...
      <table width="837" border="0" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <td width="92"><a onclick="buscar_kardex(1,<?php echo $tipoescritura;  ?>)"><img src="iconos/buscarclie.png" width="72" height="29" border="0" /></a></td>
         </tr>
      </table>
      </form>   
    </td>
