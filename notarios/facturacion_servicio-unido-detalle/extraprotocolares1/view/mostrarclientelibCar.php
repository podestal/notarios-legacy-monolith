  ...
  <tr>
    ...
    <td width="653"><table width="647" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
      <tr>
        ...
        <td width="159" height="30"><input type="text" name="apepat" style="text-transform:uppercase"   id="apepat" value="<?php echo strtoupper($row['apepat']); ?>" /></td>
        <td width="95" height="30" ><span class="camposss">Ape.Materno</span></td>
        <td width="163" height="30" ><input type="text" name="apemat" style="text-transform:uppercase" id="apemat" value="<?php echo strtoupper($row['apemat']); ?>" /></td>
  ...
  <tr>
    ...
    <td width="725"><div id="tipocondicionk" class="tipoacto" style="overflow:auto;"></div></td>
      ...
      <tr>
        ...
        <td height="30"><input type="text" name="prinom" style="text-transform:uppercase" id="prinom" value="<?php echo strtoupper($row['prinom']); ?>" /></td>
        <td height="30" ><span class="camposss">2do Nombre</span></td>
        <td height="30" ><input type="text" name="segnom" style="text-transform:uppercase" id="segnom" value="<?php echo strtoupper($row['segnom']); ?>"  /></td>
        <td height="30" >&nbsp;</td>
      </tr>
      <tr>
        <td height="30" ><span class="camposss">Dirección</span></td>
        <td height="30" colspan="3"><input name="direccion" type="text" style="text-transform:uppercase" id="direccion" value="<?php echo strtoupper($row['direccion']); ?>" size="60" /></td>
        <td height="30" >&nbsp;</td>
      </tr>
      <tr>
        <td width="103" height="30" >Telefono</td>
        <td height="30"><input name="telfijo" type="text" id="telfijo" style="text-transform:uppercase;" size="10" value="<?php
		$sql = mysql_query("select ingreso_cartas.telf_remitente from ingreso_cartas where id_remitente='".$row['numdoc']."'",$conn);
		$rowcont = mysql_fetch_array($sql);
		echo $rowcont['telf_remitente']; 
		 ?>" /></td>
        <td height="30">&nbsp;</td>
        <td height="30">&nbsp;</td>
        <td height="30" >&nbsp;</td>
