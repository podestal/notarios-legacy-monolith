    ...
    <tr>
      <td align="center"><table width="863" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <form id="frm_fechas" name="frm_fechas" method="post" action="../pdf/reporte_rc.php">
            <table width="834" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="34"><a href="#" onClick="pdf_reportec()"><img src="../../iconos/icon_pdf.png" alt="" width="33" height="31" border="0" /></a></td>
