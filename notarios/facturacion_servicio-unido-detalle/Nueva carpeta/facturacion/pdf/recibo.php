...
?>
  <tr>
    <td height="30" colspan="8" class="aaaa">&nbsp;</td>
  </tr>
  <tr>
    <td height="37" colspan="8" class="aaaa">&nbsp;</td>
  </tr>
  <tr>
    <td height="15" class="aaaa">&nbsp;</td>
    <td height="15" class="aaaa">&nbsp;</td>
    <td width="35" height="15" class="aaaa">&nbsp;</td>
    <td width="127" class="aaaa"><?php echo $arr_regventa[2]."-".$arr_regventa[3]; ?></td>
    <td height="15" class="aaaa">&nbsp;</td>
    <td height="15" class="aaaa">&nbsp;</td>
    <td height="15" class="aaaa">&nbsp;</td>
    <td height="15" class="aaaa">&nbsp;</td>
  ...
  <tr>
    <td colspan="8" class="aaaa"><div align="right">&nbsp;</div></td>
  </tr>
  <tr>
    <td width="66" class="aaaa">&nbsp;</td>
	<td width="197"><?php 
	if(strlen($numkardex)<=20){
	echo strtoupper($numkardex);
	}else{
	echo strtoupper(substr(str_replace("?","'",$numkardex),0,strrpos(substr(str_replace("?","'",$numkardex),0,20)," "))); 
	 }
	 ?></td>
  ...
  <tr>
	...
	?></div></td>
    <td width="27" valign="top"><?php echo dame_dia(); ?></td>
    <td width="25" valign="top"><?php echo dame_mes(); ?></td>
    <td width="181" valign="top"><?php echo dame_anio(); ?></td>
    <td width="6">&nbsp;</td>
  </tr>
  <tr>
    <td height="23" class="aaaa">&nbsp;</td>
    <td colspan="7">&nbsp;</td>
  </tr>
</table>
<table width="700" class="aaaa">
...
for($i=0; $i<count($arr_dregventas); $i++){
    ...
    <td width="359"><div align="left"><?php echo strtoupper($matriz2[$j]); ?></div></td>
    <td width="75" align="right"><?php echo number_format($pre, 2, '.', ' '); ?></td>
    <td width="171">&nbsp;</td>
    </tr>
	<?php
	   }else{
   ...
   <?php
    ...
    <td width="45" height="19">&nbsp;</td>
    <td width="26"><?php echo (int)$arr_dregventas[$i][6]; ?></td>
    <td width="359"><div align="left"><?php echo $arr_dregventas[$i][4]; ?></div></td>
    <td width="75" align="right"><?php echo number_format($pre, 2, '.', ' '); ?></td>
    <td width="171">&nbsp;</td>
    </tr>
	<?php
...
<table width="700" class="aaaa">
  ...
  <tr>
    <td width="80" >&nbsp;</td>
    <td width="356" ></td>
    <td width="73" align="right" valign="bottom" ><?php echo number_format($arr_regventa[16], 2, '.', ' '); ?></td>
    <td width="171" >&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
