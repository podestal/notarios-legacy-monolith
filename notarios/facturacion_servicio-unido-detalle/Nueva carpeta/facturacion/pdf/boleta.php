...
<table width="1000" class="aaaa" >
  ...
  <tr>
    <td height="28" colspan="2" align="right" ><?php echo $arr_regventa[10]; ?></td>
    <td width="248"  ></td>
    <td height="28" >&nbsp;</td>
    <td width="144" height="28" align="center" valign="top"  ><?php echo $arr_regventa[2]."-".$arr_regventa[3]; ?></td>
    <td width="41" align="center" valign="top"  >&nbsp;</td>
    <td height="28" colspan="4" valign="top" ></td>
  </tr>
  <tr>
    <td >&nbsp;</td>
    <td colspan="6" class="bbbb"><div align="left" ><?php
  ...
  <tr>
    <td width="127" >&nbsp;</td>
	<td colspan="2" class="bbbb"><div align="left"><?php 
	...
	echo strtoupper(substr($arr_regventa[8],0,strrpos(substr($arr_regventa[8],0,$maximo_direccion)," "))); 
	 ...
	 ?></div></td>
    <td width="76" class="bbbb">&nbsp;</td>
    <td colspan="3" class="bbbb"><div align="left"><?php echo $arr_regventa[7]; ?></div></td>
    <td width="53"><?php echo dame_dia(); ?></td>
    <td width="44"><?php echo dame_mes_corto(); ?></td>
    <td width="126"><?php echo dame_anio(); ?></td>
  </tr>
  <tr>
...
for($i=0; $i<count($arr_dregventas); $i++){
   ...
   <tr>
    ...
    <td width="83"><?php echo (int)$arr_dregventas[$i][6]; ?></td>
    <td width="552"><div align="left"><?php echo strtoupper($matriz2[$j]); ?></div></td>
    <td width="122"><?php echo number_format($arr_dregventas[$i][5], 2, '.', ' '); ?></td>
    <td width="177"><?php echo number_format($pre, 2, '.', ' '); ?></td>
  </tr>
	<?php
	   }else{
	?>
   ...
   <?php
    ...
    <td width="42" height="19" >&nbsp;</td>
    <td width="83"><?php echo (int)$arr_dregventas[$i][6]; ?></td>
    <td width="552"><div align="left"><?php echo $arr_dregventas[$i][4]; ?></div></td>
    <td width="122"><?php echo number_format($arr_dregventas[$i][5], 2, '.', ' '); ?></td>
    <td width="177"><?php echo number_format($pre, 2, '.', ' '); ?></td>
  </tr>
	<?php
...
<table width="1000" class="aaaa" >
  <tr>
    ...
    <td colspan="3" valign="top" >
      <div align="left"><?php echo  strtoupper(valorEnLetras($arr_regventa[16])); ?></div></td>
    <td width="174" >&nbsp;</td>
  </tr>
  <tr>
    <td height="15">&nbsp;</td>
