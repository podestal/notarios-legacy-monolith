...
$row_detalle =  mysql_fetch_array($sql);
$id =$row_detalle[0];
...
<table width="1300" class="aaaa">
  ...
  <tr>
    ...
    <td width="72" >&nbsp;</td>
    <td width="347" >&nbsp;</td>
    <td width="185" valign="top" ><?php echo $arr_regventa[10]; ?></td>
    <td width="101" ><?php echo $arr_regventa[2]."-".$arr_regventa[3]; ?></td>
    <td colspan="5" >&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="21" >&nbsp;</td>
    <td colspan="9" class="bbbb"><div align="left"><?php
  ...
  <tr>
    ...
    <td width="121" valign="top"><?php echo dame_dia(); ?></td>
    <td width="186" valign="top"><?php echo dame_mes(); ?></td>
    <td width="19" align="right">&nbsp;</td>
    <td width="26" align="right" valign="top"><?php echo dame_anio(); ?></td>
  </tr>
  <tr>
...
for($i=0; $i<count($arr_dregventas); $i++){
	...
	if(strlen($arr_dregventas[$i][4])>=$maximo_descripcion+1){
	   $matriz2=array();
       $matriz2=detalle($arr_dregventas[$i][4]);
	for($j=0; $j<count($matriz2); $j++){
       if($j==0){
	?>
	<tr>
    <td height="21" width="63" >&nbsp;</td>
    <td width="74"><?php echo (int)$arr_dregventas[$i][6]; ?></td>
    <td width="870"><?php echo strtoupper($matriz2[$j]); ?></td>
    <td width="158"><?php echo number_format($arr_dregventas[$i][5], 2, '.', ' '); ?></td>
    ...
    <td height="21" width="63" >&nbsp;</td>
    <td width="74">&nbsp;</td>
    <td width="870"><div align="left"><?php echo strtoupper($matriz2[$j]); ?></div></td>
    <td width="158">&nbsp;</td>
    <td width="111">&nbsp;</td>
    </tr>
<?php
   ...
   <tr>
    <td height="21" width="63" >&nbsp;</td>
    <td width="74"><?php echo (int)$arr_dregventas[$i][6]; ?></td>
    <td width="870"><?php echo $arr_dregventas[$i][4]; ?></td>
    <td width="158"><?php echo number_format($arr_dregventas[$i][5], 2, '.', ' '); ?></td>
    <td width="111"><?php echo number_format($pre, 2, '.', ' '); ?></td>
   </tr>
	<?php
...
<table width="1300" class="aaaa" >
  ...
  <tr>
    ...
    <td colspan="4" >&nbsp;</td>
    <td >&nbsp;</td>
    <td width="108" valign="top" ><?php echo number_format($arr_regventa[14], 2, '.', ' '); ?></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
...
<?php 
	...
	?>
     <td width="61" valign="top"><?php echo dame_dia(); ?></td>
    <td width="77" rowspan="2"></td>
    <td width="109" valign="top"><?php echo dame_mes_corto(); ?></td>
    <td width="8" rowspan="2"></td>
    <td width="80" valign="top"><?php echo dame_anio(); ?></td>
	<?php
	}
	?>
  ...
  <tr>
    ...
    <td colspan="4">&nbsp;</td>
    <td>&nbsp;</td>
    <td valign="top"><?php echo number_format($arr_regventa[16], 2, '.', ' '); ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;</td>
    <td colspan="4" valign="top">GRACIAS POR SU VISITA</td>
    <td colspan="4" valign="top"><?php echo dame_hora(); echo (' S.E.U.O'); ?></td>
    <td colspan="5">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
