...
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
        	...
        	<title>.::Comprobantes Emitidos - Pendientes de Pago::.</title>
            <style type="text/css">
			#logo_emp{
				float:left;
				padding:0px;
...
<p align="center">  <br><br>
     <strong>COMPROBANTES EMITIDOS - PENDIENTES DE PAGO</strong></p>
...
<TABLE  BORDER=1 CELLSPACING=0 CELLPADDING=0 align="center">
       ...
       <TR><td width="70" height="19" >Fec.Emision</td>
              ...
              <td width="90" align="right" >Imp. Total</td>
              <td width="90" align="right" >Saldo</td></TR>
</TABLE>
<?php 
...
$consulta = mysql_query("SELECT DATE_FORMAT(m_cteventas.fecha,'%d/%m/%Y') AS 'Fec.Emision', 'NO PAGADO' AS 'Fec.Pago', tip_documen.des_docum AS 'Tipo', m_cteventas.serie AS 'Serie',
...
m_regventas.subtotal AS 'BaseImp.', m_regventas.impuesto AS 'I.G.V.', m_regventas.imp_total AS 'Imp.Total', m_cteventas.saldo as 'saldo'
FROM m_cteventas
...
WHERE m_cteventas.fecha >= STR_TO_DATE('".$fechade."','%d/%m/%Y') AND m_cteventas.fecha <= STR_TO_DATE('".$fechaa."','%d/%m/%Y') AND m_cteventas.saldo <> 0.00 ORDER BY m_cteventas.fecha ASC ", $conn) or die(mysql_error());
...
echo"<TABLE BORDER='1' CELLPADDING='0' CELLSPACING='0' ALIGN='CENTER'>
  <TR>
	...
	<td width='90' align='right' valign='top'>".$row['saldo']."</td>
  </TR>
</TABLE>";
}
?>
