...
$grabarpodercontratantes="UPDATE poderes_contratantes SET poderes_contratantes.c_codcontrat = '$numdoc3', poderes_contratantes.c_descontrat = '$nombre3' WHERE poderes_contratantes.c_codcontrat = '$numdoc3'";
