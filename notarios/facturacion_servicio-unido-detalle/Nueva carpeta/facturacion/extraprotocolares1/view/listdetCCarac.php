...
FROM det_cambiocarac INNER JOIN detalle_cambios ON detalle_cambios.id_cambio = det_cambiocarac.id_dato WHERE  det_cambiocarac.id_cambio =  '$id_cambio' GROUP BY det_cambiocarac.id_dato 
