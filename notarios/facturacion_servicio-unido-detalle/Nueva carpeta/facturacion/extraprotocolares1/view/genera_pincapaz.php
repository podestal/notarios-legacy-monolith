...
$server = $row['nombre'];
//$ruta    = "C:/Doc_Generados/certificado_persona/";	
//$archivo = "CIncapaz202.odt"; 
#####################
...
$nom  = "CIncapaz".$num_crono; 
//echo "CIncapaz".$num_crono; exit();
# disco
$disk = "C:/";
# carpeta base
$mainfile = "\Doc_Generados/certificado_persona/";
