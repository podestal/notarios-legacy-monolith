...
<div class="frmcartas">
  <table width="900" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Ingreso de Poderes</span></td>
          <td width="510" align="left"><table width="454" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  if($rowu['newpod'] == '1')
              {
                    echo'<a href="IngPoderesVie.php" target="npermisos"><img src="../../iconos/nuevo.png" width="62" height="22" border="0" /></a>';
			  }else{
              ...
              <td width="118"><a href="listPoderes.php" target="npermisos"><img src="../../images/search.png" width="22" height="22" border="0" /></a></td>
              </tr>
          </table></td>
          <td width="29">&nbsp;</td>
        </tr>
    ...
    <tr>
      <td align="center"><iframe name="npermisos" src="listPoderes.php" frameborder="0" width="880" height="800" allowtransparency="true" scrolling="auto"></iframe></td>
    </tr>
  </table>
</div>
</body>
