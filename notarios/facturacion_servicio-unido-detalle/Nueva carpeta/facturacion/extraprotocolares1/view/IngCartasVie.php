  ...
  <tr>
    ...
    <table  width="100%">
        <tr>
          ...
          <td colspan="3"><input name="destinatario2" type="text" id="destinatario2" style="text-transform:uppercase" size="60" onkeypress="return tabulador(this, event);return soloLetrasynumeros(event)" maxlength="400" onKeyUp="destinatario1();" /></td>
          </tr>
        <tr>
          <td><span class="camposss">Dir. destino</span></td>
          <td colspan="3"><input name="dirdestino2" style="text-transform:uppercase" onKeyUp="dirdestinatario1();" type="text" id="dirdestino2" onkeypress="return tabulador(this, event);return soloLetrasynumeros(event)" size="60" maxlength="400" /></td>
          </tr>
        <tr>
