...
<title>Reporte de Comprobantes - Cancelados</title>
...
<script type="text/javascript" src="../Ajax/rep_cancelados.js" ></script>
  ...
  <table width="900" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="354"><span class="titulosprincipales">Reporte de Comprobantes Cancelados</span></td>
          <td width="484" align="left"><table width="454" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="49"><a onClick="retorna();" style="cursor:pointer" target="ncartas"><img src="../../images/back.png" width="20" height="18" border="0" title="Restaurar"/></a></td>
            </tr>
          </table></td>
          <td width="29"></td>
        </tr>
    ...
    <tr>
      <td align="center"><table width="863" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <form id="frm_fechas" name="frm_fechas" method="post" action="">
            <table width="834" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="58"><span class="Estilo7">De Fecha </span></td>
                ...
                <td width="276"><a href="#" onclick="listar_rep_cancelados(1)"><img src="../../iconos/buscarclie.png" width="72" height="29" border="0" /></a></td>
                <td width="37"><a href="#" onClick="pdf_cancelados()"><img src="../../iconos/icon_pdf.png" alt="" width="33" height="31" border="0" /></a></td>
                <td width="4">&nbsp;</td>
              </tr>
            </table>
          </form>
        ...
        <tr>
          <td><div id="list_cancelados"></div></td>
        </tr>
      </table></td>
    </tr>
  </table>
