...
<script type="text/javascript" src="../Ajax/cancelacion.js" ></script>
...
<body style="font-size:62.5%;" onLoad="listar_cancelar(1)">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
    <tr>
     <td>
         ...
         <form id="frm_cancelados" name="frm_cancelados">
         <table  width="100%">
         	<tr>
                ...
                <select id="a_tipcomp" name="a_tipcomp" style='width:167px;' class='camposss' onChange="listar_cancelar(1)">
            ...
            <tr>
                ...
                <input type="button" value="Buscar" onClick="listar_cancelar(1)"  class="camposss" /></td>
            </tr>
          </table>
          </form>
          </div>
    ...
    <tr>
       <td>
         <div id="div_cancelar" style="margin-top:0px; display:none"></div>	
       </td>
    </tr>
    <tr>
      <td>
        <div id="list_cancelar" style="margin-top:0px"></div>
      </td>
    </tr>
</table>
</div>
