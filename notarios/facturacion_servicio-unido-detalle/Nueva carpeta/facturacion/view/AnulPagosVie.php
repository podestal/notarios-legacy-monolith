  ...
  <table width="900" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Edición de Comprobantes</span></td>
          <td width="510" align="left"><table width="454" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="22"><a href="AnulDocumenVie.php" target="ncartas"><img src="../../images/back.png" width="20" height="18" border="0" title="Regresar"/></a></td>
              </tr>
          </table></td>
          <td width="29">&nbsp;</td>
        </tr>
    ...
    <tr>
      ...
      <table width="880" height="800" border="0" cellpadding="0" cellspacing="0">
      	<tr>
        	<td valign="top">
            	<?php include ("AnulDocumenVie.php")?> 
            </td>
        </tr>
      </table>
      </td>
