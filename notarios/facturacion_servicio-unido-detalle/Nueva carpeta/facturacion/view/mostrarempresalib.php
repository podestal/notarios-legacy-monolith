  ...
  <tr>
    ...
    <td width="651"><table width="640" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
      <tr>
        ...
        <td height="30"><input name="apepat" type="text"  style="text-transform:uppercase"   id="apepat" value="<?php echo str_replace("*","&",str_replace("?","'",strtoupper($row['razonsocial']))); ?>" size="60" /></td>
  ...
  <tr>
    ...
    <td width="725"><div id="tipocondicion" class="tipoacto" style="overflow:auto;"></div></td>
      ...
      <tr>
        ...
        <td height="30"><input name="direccion"  style="text-transform:uppercase" type="text" id="direccion" value="<?php echo str_replace("*","&",str_replace("?","'",strtoupper($row['domfiscal']))); ?>" size="60" /></td>
        <td height="30" >&nbsp;</td>
      </tr>
      <tr>
        <td width="112" height="30" ><span class="camposss">Telefono</span></td>
        <td height="30"><input name="telofi" type="text" id="telofi"   style="text-transform:uppercase" value="<?php echo $row['telempresa']; ?>" size="20" /></td>
