  ...
  <tr>
    ...
    <td width="651"><table width="640" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
      <tr>
        ...
        <td width="153" height="30"><input type="text" name="apepat"  style="text-transform:uppercase"  id="apepat" value="<?php echo str_replace("*","&",str_replace("?","'",$apepat)); ?>" /></td>
        <td width="92" height="30" ><span class="camposss">1er Nombre</span></td>
        <td width="171" height="30" ><input type="text" name="prinom"  style="text-transform:uppercase"  id="prinom" value="<?php echo str_replace("*","&",str_replace("?","'",$prinom)); ?>" /></td>
  ...
  <tr>
    ...
    <td width="725"><div id="tipocondicion" class="tipoacto" style="overflow:auto;"></div></td>
      ...
      <tr>
        ...
        <td height="30"><input type="text" name="apemat"  style="text-transform:uppercase" id="apemat" value="<?php echo str_replace("*","&",str_replace("?","'",$apemat)); ?>" /></td>
        <td height="30" ><span class="camposss">2do Nombre</span></td>
        <td height="30" ><input type="text" name="segnom" id="segnom"  style="text-transform:uppercase" value="<?php echo str_replace("*","&",str_replace("?","'",$segnom)); ?>"  /></td>
        <td height="30" >&nbsp;</td>
      </tr>
      <tr>
        <td height="30" ><span class="camposss">Dirección</span></td>
        <td height="30" colspan="3"><input name="direccion" type="text" id="direccion"  style="text-transform:uppercase" value="<?php echo str_replace("*","&",str_replace("?","'",$direccion)); ?>" size="60" /></td>
        <td height="30" >&nbsp;</td>
      </tr>
      <tr>
        <td width="100" height="30" >Telefono</td>
        <td height="30"><input name="telfijo" type="text" id="c_fircontrat" style="text-transform:uppercase;" size="10"  value="<?php echo $telfijo; ?>" /></td>
        <td height="30">&nbsp;</td>
        <td height="30">&nbsp;</td>
