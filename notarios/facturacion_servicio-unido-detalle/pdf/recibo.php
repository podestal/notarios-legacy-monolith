...
<body>
<table width="928" class="aaaa" >
  <tr>
    <td height="15" >&nbsp;</td>
    <td width="63" height="15" >&nbsp;</td>
    <td height="15" >&nbsp;</td>
    <td height="15" >&nbsp;</td>
    <td height="15" colspan="2" align="center" valign="top" ><?php echo $arr_regventa[2]."-".$arr_regventa[3]; ?></td>
  ...
  <tr>
    <td >&nbsp;</td>
    <td colspan="6" class="bbbb"><div align="left" ></div></td>
    <td >&nbsp;</td>
    <td >&nbsp;</td>
    <td >&nbsp;</td>
  </tr>
  <tr>
	...
	<td colspan="2" valign="bottom" class="bbbb"><div align="left"><?php 	
    ...
    <td colspan="3" class="bbbb"><div align="left"></div></td>
    <td width="49"><?php echo dame_dia(); ?></td>
    <td width="42"><?php echo dame_mes_corto(); ?></td>
    <td width="63"><?php echo dame_anio(); ?></td>
  </tr>
  <tr>
...
for($i=0; $i<count($arr_dregventas); $i++){
  ...
  <tr>
    ...
    <td width="79"><?php echo (int)$arr_dregventas[$i][6]; ?></td>
    <td width="484"><div align="left"><?php echo strtoupper($matriz2[$j]); ?></div></td>
    <td width="185">&nbsp;</td>
    <td width="81"><?php echo number_format($pre, 2, '.', ' '); ?></td>
  </tr>
	<?php
	   }else{
	?>
 <tr>
  ...
  <tr>
    <td width="37" height="18" >&nbsp;</td>
    <td width="79"><?php echo (int)$arr_dregventas[$i][6]; ?></td>
    <td width="484"><div align="left"><?php echo $arr_dregventas[$i][4]; ?></div></td>
    <td width="185">&nbsp;</td>
    <td width="81"><?php echo number_format($pre, 2, '.', ' '); ?></td>
  </tr>
	<?php
...
<table width="892" class="aaaa" >
  ...
  <tr>
    <td height="9">&nbsp;</td>
    <td width="146">&nbsp;</td>
    <td width="268">GRACIAS POR SU VISITA</td>
    <td width="277"><?php echo dame_hora();?></td>
    <td valign="top"></td>
  </tr>
