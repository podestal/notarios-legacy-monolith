...
<table width="1300" class="aaaa">
  ...
  <tr>
    ...
    <td width="135" valign="top"><?php echo dame_dia(); ?></td>
    <td width="162" valign="top"><?php echo dame_mes(); ?></td>
    <td width="19" align="right">&nbsp;</td>
    <td width="45" align="right" valign="top"><?php echo dame_anio(); ?></td>
  </tr>
  <tr>
...
<?php 
	...
	?>
    <td width="52" valign="top"><?php echo dame_dia(); ?></td>
    <td width="66" rowspan="2"></td>
    <td width="87" valign="top"><?php echo dame_mes_corto(); ?></td>
    <td width="2" rowspan="2"></td>
    <td width="66" valign="top"><?php echo dame_anio(); ?></td>
	<?php
	}
	?>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td width="56" rowspan="2" valign="middle">18</td>
