...
//AjaxReturn('../../reportes_word/generador_permiviaje_interior.php?id_viaje='+_id_viaje+'&usuario_imprime='+_usuario_imprime+'&nom_notario='+_nom_notario);
		window.open("genera_protesto_aval.php?num_protesto="+eval_numprote+"&usuario_imprime="+_usuario_imprime+"&nom_notario="+_nom_notario+"&anio="+anio);		
	}
...
<table width="95%" BGCOLOR="#CCCCCC" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr>
  <td>
  ...
  <tr>
    ...
    <tr><td>&nbsp;</td></tr>
        <tr>
          <td width="71%" align="right"><SPAN style="color:#333; font-weight:bold; font-size:24px; font-style:italic">NOTIFICACIONES</SPAN></td>
