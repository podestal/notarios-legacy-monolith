<?php
 /*
 * Commentarios   : Reporte Alfabetico de Testamentos.
 * Fecha Creacion : 
 * Creado por     :
 * Actualización  :
 * Observación    : 
...
function Header(){
 ...
 //$this->Image('images/1.png',10,8,40);
  ...
  $this->Cell(30,10,'INDICE ALFABETICO DE TESTAMENTOS',0,0,'C');// Titulo de acuerdo a los parametros
