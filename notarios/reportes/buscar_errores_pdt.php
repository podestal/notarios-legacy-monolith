<?php
    ...
    $queryRentaTerceraCategoria = "SELECT 
            ...
            WHERE cxa.parte=1 and (k.responsable_new = '$usuario') and k.codactos = '030' AND (re.pregu1 IS NULL OR re.pregu2 IS NULL OR re.pregu3 IS NULL)
    ...
    $queryDetalleBienes = "SELECT 
                ...
                WHERE k.responsable_new = '$usuario' AND (k.codactos = '030' OR k.codactos = '084' OR k.codactos = '033' OR k.codactos = '036' OR k.codactos = '037' OR k.codactos = '047' OR k.codactos = '024') AND (db.detbien IS NULL OR db.idtipbien=0 OR tipob='')
                ORDER BY k.idkardex ASC";
...
$queryOrigenFondo = "SELECT 
                    ...
                    WHERE k.responsable_new = '$usuario' AND (k.codactos = '094') AND (cxa.ofondo='')  AND fechaescritura > '2021-05-01' and (cxa.parte='1' or cxa.parte='2')
                    ORDER BY k.idkardex ASC";
