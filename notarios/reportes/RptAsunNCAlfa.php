...
$nomrepor = "ASUNTOS NO CONTENCIOSOS";
...
function Header(){
 ...
 //$this->Image('images/1.png',10,8,40);
  ...
  $this->Cell(30,10,'INDICE ALFABETICO DE ASUNTOS NO CONTENCIOSOS',0,0,'C');// Titulo de acuerdo a los parametros
...
$cabecera=array('Contratantes','Fecha Escr.','Kardex','Acto','N.Instrum.','Min/Sol','N.Folio');
