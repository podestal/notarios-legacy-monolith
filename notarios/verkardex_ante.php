...
$sqlvkardex=mysql_query("SELECT kardex.*, DATE_FORMAT(kardex.fechaescritura,'%d/%m/%Y') AS 'fechaescritura2' FROM kardex where kardex='$vkardex' and idkardex='$realid_kard'",$conn) or die(mysql_error());
...
function gmediopago2()
    {   
		var codkardex          = $("#codkardex").val();   
		var mediopago2         = $("#mediopago6").val();  
		var entidadfinanciera2 = $("#entidadfinanciera6").val();  
      ...
      <td><form id="frmprotocolares" name="frmprotocolares" method="post" action="actualizar_kardex.php">
          <table width="830" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="745" bgcolor="#264965"><span class="submenutitu">Kardex</span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="798" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="248" height="26" valign="bottom"><span class="camposss">Tipo de Kardex : </span></td>
                    <td width="118" height="26" valign="bottom"><span class="camposss">Fecha de Ingreso</span></td>
                    <td height="26" colspan="2" align="left" valign="bottom" class="camposss">&nbsp;</td>
                    <td width="170" rowspan="3" align="center" valign="middle"><div id="resultado" style="width:100px;">
                      <input name="codkardex"  type="text" id="codkardex" style="font-family:Calibri; font-size:24px; color:#003366; border:none;" value="<?php echo $rowvkardex['kardex']; ?>" size="8" readonly />
                    	<input name="idcodkardex"  type="hidden" id="idcodkardex" value="<?php echo $realid_kard; ?>"  />
                    </div></td>
                  </tr>
                  <tr>
                    <td height="31"><select name="idtipkar" id="idtipkar" onChange="cambiar()">
                      <?php
		...
		?>
                    ...
                    <td height="31"><input type="text" name="fechaingreso" class="tcal" id="fechaingreso"  size="18" value="<?php echo $rowvkardex['fechaingreso']; ?>" readonly 
 /></td>
                    <td width="104" align="center" valign="middle"><label>
                      <input name="horaingreso" readonly type="hidden" value="<?php echo $horaingreso; ?>" id="horaingreso" size="15" />
                    </label></td>
                    <td width="158" height="31" align="right" class="kardex">Nº Kardex:</td>
                  </tr>
                  <tr>
                    <td height="28" colspan="4" valign="bottom"><table width="601" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="75" height="27"><span class="camposss">Referencia :</span></td>
                          <td width="526"><input name="referencia" type="text" id="referencia" style="text-transform:uppercase" onKeyUp="cambioampe()" value="<?php 
                  ...
                  <tr>
                    <td height="28" colspan="5"><table width="697" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="96"><span class="camposss">Codigo de  Actos
                          <label></label>
                        </span></td>
                        <td width="72"><span class="camposss">
                        ...
                        <td width="161" align="right" class="camposss">Derecho Notarial :</td>
                        <td width="109"><label>
                        ...
                        <td width="113" align="right" class="camposss">Derecho Registral :</td>
                        <td width="146"><input name="dregistral" type="text" id="dregistral" size="10" onChange="valorreg(this.value)" onKeyUp="return numregi(this.value)" onBlur="this.value=formatCurrency(this.value);" value="<?php if($rowvkardex['dregistral']==''){echo '0.00';}else {echo $rowvkardex['dregistral'];} ?>" /></td>
                      </tr>
                    </table>                      <label></label></td>
                  </tr>
                  <tr>
                    <td height="14" colspan="5" class="camposss"><table width="765" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="97">Contrato</td>
                          <td width="689"><table width="682" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="506" height="27"><input name="contrato" type="text" id="contrato" style="text-transform:uppercase" onKeyPress="return soloLetras(event)" value="<?php echo $rowvkardex['contrato']; ?>" size="80" maxlength="800" /></td>
                                <td width="84">
                                <?php
							  if($rowu['editkar'] == '1')
              {
...
<span style="color:#F00">*</span>
	     ...
	     ?>
                                                            ...
                                                            <div id="vermediopagoedit" style="display:none; border: #003366 solid 1px; background-color:#CCCCCC; position:absolute; width: 729px; left: 5px; top: 224px; height: 189px; z-index:89898989898989;">
</div>
...
?><!--<input name="idplacav" type="text"  id="idplacav" style="background:#FFFFFF" size="1" maxlength="2" />--></td>
                                              ...
                                              <tr>
                                              	<td colspan="2"><div id="listvehiculos" style="display:none">Listado de Vehiculos</div>
                                              	</td>
                                              </tr>
                                            </table>
                                      </div>
	   ...
	   ?>" id="encargado" />
                      ...
                      <table width="740" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="382" class="style2">Formularios</td>
                              <td width="30" class="style2"><a href="#" onClick="ocultar_desc('formurent')"><img src="iconos/cerrar.png" width="21" height="20" border="0" /></a></td>
                            </tr>
                            <tr>
                              <td rowspan="3">&nbsp;</td>
                              <td width="94" height="31" class="Estilo31">N° formulario</td>
                            <td width="217"><label>
                              ...
                              <td colspan="2" rowspan="3" valign="top"><table width="374" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="374"><table width='350' border='1' bordercolor="#333333" cellspacing='0' cellpadding='0'>
                                    <tr>
                                      <td width='175' class="Estilo15" >Numero de Formulario</td>
                                      <td width='175' class="Estilo15" >Monto</td>
                                      <td width='20' >&nbsp;</td>
                                    </tr>
                                  </table></td>
                                </tr>
...
?> </div></td>
 ...
 if($rowu['editkar'] == '1')
   ...
   echo'<input type="button" name="button4" id="button4" value="Generar" onClick="mostraruifpdtasigna()" />';
                    ...
                    <div id="clienbus" class="clienbus1" style="display:none; z-index:7;">
                          <table width="760" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td colspan="3"><table width="724" border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    <td height="54" colspan="5" bgcolor="#FFFFFF"><div id="busclie" style=" width:720px; height:250px; overflow:auto"> </div></td>
                                  </tr>
                              </table></td>
                            </tr>
                        </table>
                      ...
                      <div id="tabsss" style="display:; z-index:1;">
                          <table width="755" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="97" class="camposss">Kardex Conexo</td>
                              <td width="112"><input name="kardexconexo" type="text" id="kardexconexo" size="15" maxlength="6" value="<?php echo $rowvkardex['kardexconexo']; ?>" /></td>
                              <td width="69" class="camposss" align="center">Notaria</td>
                              <td width="204"><label>
    ...
    <img src="iconos/nc1.fw.png"
onClick="if(confirm('Esta seguro que desea continuar .. ?')){

if(confirm('Desea crear otro kardex ahora .. ?')){
...
ncsinkardex();
    ...
    <?PHP
}else if($rowvkardex['nc']==1 && $conteo==1){
?>
<img src="iconos/nc3.fw.png" 
onClick="if(confirm('El kardex ya ha sido procesado como no corre, desea crear otro kardex .. ?')){
 ...
 <!--                                                   <tr>
                                    ...
                                    <div id="tab4" class="Contenido">
                                      <table width="730" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="160" height="28" align="right" class="camposss"><div id="min4"># de Minuta : <span style="color:#F00"> </span></div><div id="minsol" style="display:none;"># de Minuta/Sol : <span style="color:#F00"></span></div></td>
                                          <td width="144" class="camposss"><input name="numminuta" type="text" id="numminuta" value="<?php echo $rowvkardex['numminuta']; ?>" size="12" maxlength="7" /></td>
                                          <td width="140" align="right" class="camposss"><div id="escri4"># Escritura : </div><div style="display:none" id="escri5"># Acta : </div><div style="display:none" id="numins"># Instrumento :</div></td>
                                          <td width="121" class="camposss"><input name="numescritura" type="text" id="numescritura"  onKeyPress="return NumCheck(event, this);" value="<?php echo $rowvkardex['numescritura']; ?>" size="12" maxlength="7"/><span style="color:#F00">*</span></td>
                                          <td width="175" class="camposss"><div id="mela">
                                        ...
                                        <tr>
                                          <td colspan="5" class="camposss"><table width="740" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="160" height="30" align="right">#Folio del</td>
                                              <td width="64"><label></label>
                                                    <input name="folioini" type="text" id="folioini" size="10" maxlength="7" value="<?php echo $rowvkardex['folioini']; ?>" /></td>
                                                <td width="82" align="center">al</td>
                                              <td width="200"><label></label>
                                                    <input name="foliofin" type="text" id="foliofin" size="10" maxlength="7" value="<?php echo $rowvkardex['foliofin']; ?>"/></td>
                                                <td width="82">&nbsp;</td>
                                        ...
                                        <tr>
                                          <td colspan="5" class="camposss"><table width="740" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="161" height="30" align="right">Papel Notarial del : </td>
                                              <td width="65"><label></label>
                                                    <input name="papelini" type="text" id="papelini" size="10" value="<?php echo $rowvkardex['papelini']; ?>" /></td>
                                                <td width="80" align="center">al</td>
                                              <td width="162"><label></label>
                                                    <input name="papelfin" type="text" id="papelfin" size="10" value="<?php echo $rowvkardex['papelfin']; ?>" /></td>
                                                <td width="120">&nbsp;</td>
                                                <td width="66"><label></label>                                                </td>
                                                <td width="21">&nbsp;</td>
                                                <td width="65">&nbsp;</td>
                                        ...
                                        <tr>
                                          <td colspan="5" class="camposss"><table width="740" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="30" align="right"><div id="tom"></div></td>
                                                <td><div id="tom1"><input name="tomox" type="hidden" id="tomox" size="15" value="<?php echo $rowvkardex['txa_minuta']; ?>" /></div></td>
                                                <td align="right" lass="camposss"><div id="regisx"></div></td>
                                                <td><div id="regisx1"><input name="regx" type="hidden" id="regx" size="15" value="<?php echo $rowvkardex['numinstrmento']; ?>" /></div></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                              </tr>
                                              <tr>
                                                <td width="161" height="30" align="right"><div id="fecesc">Fecha de Escritura :</div><div id="fecact" style="display:none;">Fecha de Acta : </div><div id="fecins" style="display:none;">Fecha Instrumento : </div></td>
                                                <td width="144"><label></label>
                                                    <input name="fechaescritura" type="text" id="fechaescritura" class="tcal" size="12" value="<?php echo $rowvkardex['fechaescritura2']; ?>" readonly  /><span style="color:#F00">*</span></td>
                                                <td width="104" align="right" lass="camposss"><!--Fecha de Conclusion--></td>
                                                <td width="156">
