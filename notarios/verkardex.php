...
$sqlvkardex=mysql_query("SELECT kardex.*, DATE_FORMAT(kardex.fechaescritura,'%d/%m/%Y') AS 'fechaescritura2' ,DATE_FORMAT(kardex.fechaminuta,'%d/%m/%Y') AS 'fechaminuta2',idPresentante  FROM kardex where kardex='$vkardex' and idkardex='$realid_kard'",$conn) or die(mysql_error());
...
$sqltt_ab =mysql_query("SELECT * FROM tb_abogado ",$conn) or die(mysql_error());
...
$name1 = '';
$name2 = '';
$idPresentante = $rowvkardex['idPresentante'];
$sql1 = "SELECT *FROM cliente WHERE idcliente = '".$idPresentante."'";
$result = mysql_query($sql1);
$rowSentative = mysql_fetch_array($result);

if($rowSentative){
	$idSentative = $rowSentative['idcliente'];
	$numberDocument = $rowSentative['numdoc'];
	$surname1 = $rowSentative['apepat'];
	$surname2 = $rowSentative['apemat'];
	$name1 = $rowSentative['prinom'];
	$name2 = $rowSentative['segnom'];
}
?>
...
function fncBorrarEscrit()
{
	jQuery("#numminuta").val("");
	jQuery("#numescritura").val("");
	jQuery("#folioini").val("");
	jQuery("#foliofin").val("");
	jQuery("#papelini").val("");
	jQuery("#papelfin").val("");
	jQuery("#tomox").val("");
	jQuery("#regx").val("");
	jQuery("#fechaescritura").val("");
	jQuery("#isBorrarEscritura").val("1");
...
$('#txtDniPresentante').live( "keypress", function(e) {
		...
		var vdni = this.value;
		  if (e.which == '13') {
		  	...
		  	$.ajax({
		  		...
		  		data:{numberDocument:vdni},
		  		dataType:'json',
		  		type:'POST',
		  		success:function(response){

		  			if(response.error == 0){
		  				$('#txtIdCliente').val(response.pkCustomer);
		  				$('#txtSurname1').val(response.surname1);
		  				$('#txtSurname2').val(response.surname2);
		  				$('#txtName1').val(response.name1);
		  				$('#txtName2').val(response.name2);
		  			}else{
		  				$('#msgConsultCliente').show();
		  				$('#msgConsultCliente').text(response.errorDescripcion);
		  			}
...
function gmediopago2()
	...
	if(mediopago2=='1' || mediopago2=='7' || mediopago2=='2' || mediopago2=='3'){
...
function muesVehiEditable2(_obj)
{
	...
	if(document.getElementById('fecinscv2')){
		$("#fecinscv2").mask("99/99/9999",{placeholder:"_"});
	}
}
...
function cambiar2()
    {
		...
		{  
				...
				$("#uniform-btngenerador").attr("style","display:none");   // GENERAR DOCUMENTO
				$('#uniform-btnGenerarParteNotarial').attr("style","display:none");//aqui
				$('#uniform-btnver').attr("style","display:none;");
		} // 5	 		
	//alert(_idtacto);
	}
...
{	
	...
	if (isChecked) document.frmprotocolares.contrato.value = total + myValue + separador;
		...
		document.frmprotocolares.contrato.value = total.replace(quitar,nuevoStr);
}
...
function mostrar2(isChecked, name)
{
	...
	$('#idTemplate .option-template').remove();
...
function mostrar3(isChecked, name, id)
{
	...
	if (isChecked){ 
		...
		document.frmprotocolares.codcon.value = total3.replace(quitar3,"");
	}
}
...
div.contratantes{ width:728px; height:230px; overflow:auto;  }
...
border: 2px solid #777; border-top: none; overflow: hidden; clear: both; float: left; width: 760px; background: #ffff;
-webkit-border-bottom-right-radius: 8px;
-webkit-border-bottom-left-radius: 8px;
-moz-border-radius-bottomright: 8px;
-moz-border-radius-bottomleft: 8px;
    ...
    <tr>
      <td><form id="frmprotocolares" name="frmprotocolares" method="post" action="actualizar_kardex.php">
		...
		?>
                  ...
                  <tr>
                    <td height="28" colspan="5" valign="bottom"><table width="687" border="0" cellspacing="0" cellpadding="0">
                        <tr>
						  ...
						  echo strtoupper($textoreferenciajesus); ?>" size="90" maxlength="800" />
                  ...
                  <tr>
                    ...
                    <table width="739" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="100" height="22" align="right"><span class="camposss">Codigo de  Actos&nbsp;&nbsp;
                          <label></label>
                        </span></td>
                        ...
                        <tr>
                          ...
                          <td width="576"><table width="767" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="439">
                                <input name="contrato" type="text" id="contrato" style="text-transform:uppercase" onKeyPress="return soloLetras(event)" value="<?php echo $rowvkardex['contrato']; ?>" size="70" maxlength="800" />
                                        ...
                                        <tr>
                                          <td height="29" colspan="2" class="style30"><table width="196" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
												...
												<td width="16"><input type="text" style="position: absolute;width: 300px;left: 40%;background: white;" placehlder="FILTRAR ACTO" id="txtFiltrarGrupo"></td>
                                              </tr>
                                          </table></td>
							  ...
							  if($rowu['editkar'] == '1')
              {
                  ...
                  <tr>
                    <td height="32" colspan="7"><table width="800" border="0">
                      <tr>
                        <td width="109" align="right" valign="top"><span class="camposss">Responsable&nbsp;&nbsp;</span></td>
                        <td colspan=""><span class="camposss">
                          <input name="responsable_new" type="text" id="responsable_new" style="text-transform:uppercase" onKeyPress="return soloLetras(event)" value="<?php echo $rowvkardex['responsable_new']; ?>" size="56" maxlength="800" />
                          </span></td>
		...
		?>
                      ...
                      <tr>
                        <td width="88" height="26" align="right"><span class="camposss">Abogado&nbsp;&nbsp;</span></td>
                        <td width="26" colspan="3">
	                        <select name="idabogado" id="idabogado" >
	                          <option value="0">.::Seleccione Abogado::.</option>
							  <?php
							  while($rowAbogado = mysql_fetch_array($sqltt_ab)){ ?>
							  	 <?php if($rowAbogado['idabogado'] == $rowvkardex['idabogado']){ ?>
							  	 	<option selected value="<?php echo $rowAbogado['idabogado'];?>" ><?php echo $rowAbogado['razonsocial']; ?></option>
							   	 <?php }else{?>
							   	 	<option  value="<?php echo $rowAbogado['idabogado'];?>" ><?php echo $rowAbogado['razonsocial']; ?></option>
							  	 <?php } ?>
							  <?php } ?>
	                          </select>
	                         	...
	                         	<?php
								 	 while($row = mysql_fetch_array($reesult)){ ?>
								 	 	<?php if($row['codeActs'] == $rowvkardex['codactos']): ?>
											<?php if($row['pkTemplate'] == $rowvkardex['fkTemplate']){ ?>
												<option class="option-template" selected value="<?php echo $row['pkTemplate'];?>" ><?php echo $row['fileName']; ?></option>
											<?php }else{?>
...
<span style="color:#F00">*</span>
	     ...
	     ?>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td height="30" colspan="2"><input name="ubigens" type="text" id="ubigens" style="background:#FFFFFF" size="45" readonly="" /></td>
...
<div id="predio1" style="display:none; width:650px; height:450px; border:#003366 solid 1px; background:#CCCCCC; position:absolute; left: 23px; top: -10px; z-index:2000;">
	<form action="../models/get_predios.php" method="POST" id="formFiltrarPredios">
      <table>
          <thead>
            <tr>
              <td width="69">&nbsp;</td>
          ...
          <tbody>
			  ...
			  <tr>
					  ...
					  <td class="titupatrimo">&nbsp;</td>
				  	<td class="titupatrimo"><a href="#" onclick="set_predios('<?php echo $vkardex?>')"><img src="iconos/grabar.png" width="94" height="29" border="0" /></a></td>
              </tr>
          </tbody>
      </table>
      ...
      <table border="1" style="width:98%; border-radius:5px;margin:5px;font-size:.9em" cellspacing="0" cellpadding="0">
          ...
          <tbody id="tblPredios" class="text-center" style="background:white;font-size:.83em">
                                                    ...
                                                    <div id="listbiennes" style="display:"></div></td> <!-- DIV ACTUALIZAR BIENES -->
                                                            <div id="verbienesedit" style="display:none; border: #003366 solid 1px; background-color:#CCCCCC; position:absolute; width: 729px; left: 5px; top: 224px; height: 189px;">
                                                            	
                                                            </div>
                                                            <input name="detbienx" type="hidden" id="detbienx" />
                                              </tr>
                                            </table>
                                      </div>
...
?><!--<input name="idplacav" type="text"  id="idplacav" style="background:#FFFFFF" size="1" maxlength="2" />--></td>
                                                      ...
                                                      <tr>
                                                        <td width="246" height="30" align="right"><span class="titupatrimo">N. Placa / Poliza :</span>
                    ...
                    <div id="mantecontra" style="position:absolute; display:none; width:740px; height:250px; left: 52px; top: 348px; z-index:16; background:#CCCCCC; border: 1px solid #333333; border: 1px solid #264965; -moz-border-radius: 13px; -webkit-border-radius: 13px; border-radius: 13px; -moz-box-shadow: 0px 0px 5px #000000; -webkit-box-shadow: 0px 0px 5px #000000; box-shadow: 0px 0px 5px #000000;">
                      ...
                      <div id="editmrrpp" style="position:absolute; display:none; width:740px; height:360px; left: 54px; top: 337px; z-index:15; background:#CCCCCC; border: 1px solid #333333; border: 1px solid #264965; -moz-border-radius: 13px; -webkit-border-radius: 13px; border-radius: 13px; -moz-box-shadow: 0px 0px 5px #000000; -webkit-box-shadow: 0px 0px 5px #000000; box-shadow: 0px 0px 5px #000000;">
      ...
      <td>&nbsp;</td>
          ...
          <div id="newmrrpp" style="position:absolute; display:none; width:740px; height:360px; left: 50px; top: 385px; z-index:15; background:#CCCCCC; border: 1px solid #333333; border: 1px solid #264965; -moz-border-radius: 13px; -webkit-border-radius: 13px; border-radius: 13px; -moz-box-shadow: 0px 0px 5px #000000; -webkit-box-shadow: 0px 0px 5px #000000; box-shadow: 0px 0px 5px #000000;">
        	 ...
        	 <table width="740" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="23" height="26">&nbsp;</td>
                              <td width="273" class="Estilo15" ><div id="titleMovimiento">Ingreso de Movimientos RR. PP</div></td>
                              <td width="148">&nbsp;</td>
                              <td width="268"><label>
                            ...
                            <tr>
                              ...
                              <table width="678" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <td height="30" class="camposss">Titulo en RR.PP</td>
                                    ...
                                    <select name="idtiptraoges" id="idtiptraoges">
                                      <option value="0" selected="selected">SELECCIONAR</option> 
                                        <?php
                                  ...
                                  <td height="30" class="camposss">Oficina Registral</td>
                                    <td height="30" class="camposss">
                                    <select name="idsedereg" id="idsedereg">
                                       <option value="" selected="selected">SELECCIONAR</option> 
                                        <?php
				    ...
				    echo'';
                            ...
                            <tr>
                              <td colspan="6"><ul class="tabs">
                                ...
                                <?php 
                                	if($rowvkardex['idtipkar']==1 or $rowvkardex['idtipkar']==3 or $rowvkardex['idtipkar']==4 or $rowvkardex['idtipkar']==5 OR $rowvkardex['idtipkar']==2){
                                ?>
                                <li><a onclick="listarescrituraciondocs()" href="#tab8">Digitación</a></li>
                                <?php } ?>
                                <li><a onClick="ocultarDigitacion();Eval_sucIntestada();" href="#tab4">Escrituración</a></li>
                                        ...
                                        <tr>
                                          <td width="730" height="15"><table width="700" border="1" bordercolor="#666666" cellspacing="0" cellpadding="0">
                                              <tr>
                                                ...
                                                <!-- <td  bgcolor="#264965"><span class="btnpatrimonial">Anexo5</span></td> -->
												<td width="60" bgcolor="#264965"><span class="btnpatrimonial">Dec.Juradas</span></td>
                                              </tr>
...
while($row = mysql_fetch_array($consulta)){
  ...
  echo"</span></td>
  <td class='sinEstilos' id='sinEstilos'>
		...
		<!--OJO REMOVIDO EL DIA 09/8/2024 MARCACION DE ANEXO 5 DE SUKETOOBLIGADO A INFORMAR Y OFICIAL DE CUMPLIEMIENTO -->
		<!-- S.O.<input type='checkbox' id='oiuif' name='oiuif'>O.C.<input type='checkbox' id='ocuif' name='ocuif'> -->
                                        <tr>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
...
<table width="730" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          ...
                                          <td width="100" class="camposss"><input name="numminuta" type="text" id="numminuta" value="<?php echo $rowvkardex['numminuta']; ?>" size="11" maxlength="7" /></td>
                                          	...
                                          	<td width="103" align="right" class="camposss" style="display:<?php echo $rowvkardex['idtipkar']!=3?'block':'none'; ?>">Fecha Minuta&nbsp;&nbsp;</td>
                                           <td width="109" ><label></label>
                                           <input name="fechaminuta" type="text" id="fechaminuta" class="tcal" size="15" value="<?php echo $rowvkardex['fechaminuta2']; ?>" readonly style="display:<?php echo $rowvkardex['idtipkar']!=3?'block':'none'; ?>" /></td>
                                        ...
                                        <tr>
                                          <td colspan="7" class="camposss"><table width="740" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="127" height="30" align="right">Serie Notarial del&nbsp;&nbsp;</td>
                                          ...
                                          <td colspan="7" class="camposss"><table width="740" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                               ...
                                               <tr>
		                                          <td colspan="7" class="camposss"><table width="740" border="0" cellpadding="0" cellspacing="0">
		                                              <tr>
		                                                <td width="127" height="30" align="right">#Papel de Trasl. Notarial</td>
		                                              <td width="89"><label></label>
											...
											<style>
                                              ...
                                              <tr>
                                                ...
                                                <td width="98" align="right" lass="camposss"><a href="#" class="btnGenerarFecha" id="btnGenerarFecha" onclick="generarFechaEscritura()" >GEN. FECHA</a></td>
                                                <td width="231">
												...
												<td>
                                                	<?php 
                                                		if($rowu['editkar'] == '1' && $rowu['idusuario'] == '1'){
															 echo'<input type="button" name="btnborrarEscr" id="btnborrarEscr" value="Borrar" onClick="fncBorrarEscrit()" />';
														}

                                                	?>
													<input type="hidden" id="isBorrarEscritura" name="isBorrarEscritura" value="">
                                                </td>
                                                <td width="153">
                                                <?php
 if($rowu['editkar'] == '1')
                                    ...
                                    <div id="tab6" class="Contenido">
                                      ...
                                      <table width="732" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="19">&nbsp;</td>
                                          <td width="208">
                                          <input name="codmovreg" type="hidden" />
                                          <input name="itemcodmovreg" type="hidden" id="itemcodmovreg" />                                         </td>
                                          <td width="174"><span class="Estilo40"> </span></td>
                                          <td width="109"><span class="Estilo40"> </span></td>
                                          <td width="220">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td height="236" colspan="5">
                                          <table width="727" height="217" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
...
//    echo'<input type="button" name="button5" id="btnGenerarParteNotarial" value="Parte Notarial"  onclick="verifyDocument(2)"/>';
   echo'';
	}else{
		echo'';
	 }?>
...
<?php
 if($rowu['editkar'] == '1')
    {
   //echo'<button title="visualizar" type="button" name="btnver"    id="btnver" value="visualizar" onClick="verifyDocument(3);" ><img align="absmiddle" src="images/block.png" width="15" height="15" />Testimonio</button>';
	}else{
		echo'';
	 }?>
     ...
     <?php }?></td>
                      ...
                      </div><div id="rouif" style="display:none;"><?php $varo=mysql_query("Select * from kardex where kardex='$vkardex'", $conn) or die(mysql_error());
...
<div id="clienteDecJu" class="clienteDecJu" style="display:none; z-index:7;overflow:hidden;top:0;height:750px">
	<table>
		<tr>
			<td width="18" height="29">&nbsp;</td>
			<td width="707" class="editcampp"></td>
			<td width="35"><a id="clieee"  onclick="ocultar_desc('clienteDecJu');format();"><img src="iconos/cerrar.png" width="21" height="20" /></a></td>
		</tr>
	</table>
	<div class="card-body px-lg-5 pt-0" id="modalPdfContent">
		<!-- Form -->
...
<script language="javascript">
	...
	// const generarDeclaracionJurada = (idContratante)=>{
	// 	// console.log(idContratante)

	// 	let ocuif = document.getElementById('ocuif').checked
	// 	let oiuif = document.getElementById('oiuif').checked

	// 	let url = 'generar_declaracion_jurada.php'
	...
	if(document.getElementById('fecinscv')){
		$("#fecinscv").mask("99/99/9999",{placeholder:"_"});
	}
...
<script src="src/js/generateDeclaracionJurada.js"></script>
</body>
</html>