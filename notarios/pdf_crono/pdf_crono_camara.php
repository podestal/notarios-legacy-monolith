...
<page backtop="30mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 10pt; font:Arial;">
    <page_header>
        <p align="center">
     <strong>REPORTE DE INDICES CRONOLOGICOS INFORMA A CAMARA DEL COMERCIO</strong></p>
...
<table width='834' border='1' align="center" cellpadding='0' cellspacing='0' bordercolor='#000000' bgcolor="#003366">
		...
		<tr class="titulos">
              ...
              <td width='150' align="center"><span class='Estilo14'>Dirección Obligado o Aval</span></td>
            </tr>
    ...
    <?php include('IMPRE_crono_camara.PHP'); ?>
