...
$consulta_vehicular = "SELECT *, CAST(numescritura AS SIGNED) AS numescritura2 FROM kardex WHERE idtipkar='5' and fechaescritura <> '' 
...
echo "<table width='834' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000' align='center'>";
	...
	echo "<tr>
			...
			<td width='354' valign='top' align='center'><span class='Estilo12'>"; 
		...
		$ejecuta_clientes= mysql_query($consulta_clientes, $conexion);
			...
			echo"</span></td>
			<td width='166' valign='top' align='center'><span class='Estilo12'>".strtoupper($arr_vehicular[$j][2])."</span></td>
			<td width='91' valign='top' align='center'><span class='Estilo12'>".$arr_vehicular[$j][3]."</span></td>
			<td width='84' valign='top' align='center'><span class='Estilo12'>".$arr_vehicular[$j][5]."</span></td>
 	</tr>";
   }
