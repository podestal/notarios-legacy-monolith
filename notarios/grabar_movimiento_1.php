...
$grabarmovie="INSERT INTO detallemovimiento(itemmov, idmovreg, fechamov, vencimiento, titulorp, idsedereg, idsecreg, idtiptraoges, idestreg, encargado, anotacion, importee, observa, numeroo, mayorderecho) VALUES (NULL,'$codmove','$fechamov','$vencimiento','$titulorp','$idsedereg','$idsecreg','$idtiptraoges','$idestreg','$encargado','$anotacion','$importee','$observa','$numeroo','$mayorderecho')";
