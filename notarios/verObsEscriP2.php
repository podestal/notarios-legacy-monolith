...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
        ...
        DOCUMENTOS - <?=$row["tipogeneracion"]?> DEL KARDEX <?=$row["kardex"]?>
        </span>
        </td>
    	<td align="right" width="5%">
        <a onClick="cerrarObsEscri2()">
    ...
    <tr>
        ...
        <td>
        &nbsp;&nbsp;<input type="text" class="TITULO21" readonly="readonly" value="<?=substr($row["fecha_partest"],0,10)?>"  style="width:70%" />
        </td>                      
    </tr>
    <tr>
        <td align="right" width="15%" >
