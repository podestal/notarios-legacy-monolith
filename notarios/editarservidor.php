...
$sqlupdates="SELECT * FROM servidor where idservidor='1'"; 
...
<div class="frmprotocolar">
  <table width="900" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" bgcolor="#264965"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="328"><span class="titulosprincipales">Configuracion del servidor</span></td>
    ...
    <tr>
      <td align="center"><form id="form1" name="form1" method="post" action="grabarservidoredit.php">
        <table width="740" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="36" colspan="6"><span style="font-family:Verdana, Geneva, sans-serif; font-size:14px; color:#036;"><strong>Editar servidor</strong></span></td>
            </tr>
          <tr>
            <td width="110">&nbsp;</td>
            <td width="210">&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="4"><input type="text" class="texto" style="text-transform:uppercase;"  name="nombre" id="nombre"  size="50"  value="<?php echo $row['nombre'];  ?>" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="31">&nbsp;</td>
