...
$concatenado   = $_POST['tipoactopatri'];

$rows           = explode("|",$concatenado );
$tipoactopatri  = $rows[0];


$consulkarmp=mysql_query("SELECT * FROM detallemediopago where kardex='$codkardex' and tipacto='$tipoactopatri'", $conn) or die(mysql_error());
...
while($rowkarmp = mysql_fetch_array($consulkarmp)){
 echo"<tr>
    ...
    <td align='center' bgcolor='#FFFFFF'><a href='#' id='".$rowkarmp['detmp']."' onclick='muesdiveditar(this.id)'><img src='iconos/editamv.png' width='16' height='18'></a></td>
    <td align='center' bgcolor='#FFFFFF'><a href='#' id='".$rowkarmp['detmp']."' onclick='moselimp(this.id)'><img src='iconos/eliminamv.png' width='18' height='17'></a></td>
 </tr>";
  }
  echo"</table>";
