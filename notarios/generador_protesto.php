...
exit();
	...
	$tipop						  = $rowcartas[10];
	$importe 					  = $rowcartas[8];
	$domicilio					  = $rowparti['direccion']." ".$rowdat['domruc']."-".$rowdat['ubigeo']." - ".$rowdat['depa'];
	...
	$fec_venc      		  = $fecha->fun_fech_comple($rowcartas['fec_venc2']);
	$solicitante = $rowcartas[1];
	$desmon = $rowcartas[7];
	$obligado 					  = $rowdat['obligado'];
	$dili=$rowcartas['diligencia'];
	$telfijo=$rowdat['telfijo'];
	$numdoc=$rowdat['numdoc'];
	$valletras=valorEnLetras($importe);
