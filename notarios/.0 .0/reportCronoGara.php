...
$sql = "SELECT 
			...
			FROM kardex K 
			WHERE 
			K.idtipkar='4' and nc=0
			AND (K.fechaescritura BETWEEN '$desde' AND '$hasta') 
			ORDER BY fechaescritura, numescritura2, numminuta ASC";

$resultG = mysql_query($sql, $conn) or die(mysql_error());
$paginador=2;
...
<style type="text/css">
	...
	<table bordercolor="#585858"  BORDER="1">
		<thead>
			...
			<tr>
				<th class="cabecera" colspan="12"><b>INDICE CRONOL&Oacute;GICO DE GARANTIAS MOBILARIAS</b></th>
			</tr>
			<tr>
		...
		<tbody>
			<?php while ($row = mysql_fetch_assoc($resultG)) { 
