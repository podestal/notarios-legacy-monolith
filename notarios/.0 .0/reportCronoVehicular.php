...
if($_POST['fechade']!="" or $_POST['fechaa']!="") {
	...
	header("content-disposition: attachment;filename=VEHICULAR.xls");
	$sql = "SELECT 
...
<style type="text/css">
	...
	<table bordercolor="#585858"  BORDER="1">
		<thead>
			...
			<tr>
				<th class="cabecera" colspan="12"><b>INDICE CRONOL&Oacute;GICO DE TRANSFERENCIAS VEHICULARES</b></th>
			</tr>
			<tr>
		...
		<tbody>
			<?php while ($row = mysql_fetch_assoc($resultV)) { 
