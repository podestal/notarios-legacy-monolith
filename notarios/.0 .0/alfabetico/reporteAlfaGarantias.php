...
if($_POST['fechade']!="" or $_POST['fechaa']!="") {	
	...
	header("content-disposition: attachment;filename=ALFA_GARANTIAS.xls");
...
<table bordercolor="#585858"  BORDER="1">
	<thead>
		...
		<tr>
			<th class="cabecera" colspan="12"><b>INDICE ALFAB&Eacute;TICO DE GARANTIAS MOBILIARIAS</b></th>
		</tr>
		<tr>
