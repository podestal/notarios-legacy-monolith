...
$sql = "SELECT 
		    ...
		    WHERE K.idtipkar='1' and nc=0
		    AND (K.fechaescritura BETWEEN '$desde' AND '$hasta')
		    ORDER BY cliente ASC ";

$ejecutar = mysql_query($sql, $conn);
$paginador=2;	
...
<table bordercolor="#585858"  BORDER="1">
	<thead>
		...
		<tr>
			<th class="cabecera" colspan="12"><b>INDICE CRONOL&Oacute;GICO DE ESCRITURAS P&Uacute;BLICAS</b></th>
		</tr>
		<tr>
	...
	<tbody>
		<?php while($row = mysql_fetch_array($ejecutar)){ ?>
			<tr>
